...
/**
 * Texas counties frequently share names with plants, colors, occupations and
 * ordinary nouns (Live Oak, Orange, Wood, Bee, Falls, etc.). A bare county
 * alias is therefore unsafe for automatic linking. Explicit county phrases and
 * the known current-county context remain linkable.
 */
