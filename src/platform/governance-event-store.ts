...
function store() { return (globalStore.__texasDefinedGovernanceEvents ??= []); }
...
export function clearGovernanceEventsForTests() { globalStore.__texasDefinedGovernanceEvents = []; }
