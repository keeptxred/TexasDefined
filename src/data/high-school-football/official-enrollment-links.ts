...
export const OFFICIAL_FOOTBALL_ENROLLMENT_LINKS: readonly OfficialFootballEnrollmentLink[] = [
  ...
  },
  {
    ...
    aliases: ['Cypress-Fairbanks Independent School District', 'Cypress Fairbanks ISD'],
    enrollmentUrl: 'https://www.cfisd.net/parents-students01/student-registration-transfers/register-your-child',
    sourceLabel: 'Cypress-Fairbanks ISD new student registration',
    verifiedAt: '2026-09-19',
    schoolYear: '2026-27',
  },
  {
    districtName: 'Conroe ISD',
    aliases: ['Conroe Independent School District'],
    enrollmentUrl: 'https://www.conroeisd.net/article/2982690',
    sourceLabel: 'Conroe ISD new student registration',
    verifiedAt: '2026-09-19',
    schoolYear: '2026-27',
  },
  {
    districtName: 'Klein ISD',
    aliases: ['Klein Independent School District'],
    enrollmentUrl: 'https://enroll.kleinisd.net/',
    sourceLabel: 'Klein ISD enrollment',
    verifiedAt: '2026-09-19',
    schoolYear: '2026-27',
  },
  {
    districtName: 'Alvin ISD',
    aliases: ['Alvin Independent School District'],
    enrollmentUrl: 'https://www.alvinisd.net/o/aisd/page/welcome-back',
    sourceLabel: 'Alvin ISD enrollment and back-to-school registration',
    verifiedAt: '2026-09-19',
    schoolYear: '2026-27',
  },
  {
    districtName: 'Tomball ISD',
    aliases: ['Tomball Independent School District'],
    enrollmentUrl: 'https://www.tomballisd.net/new-to-tomball/registration-enrollment',
    sourceLabel: 'Tomball ISD registration and enrollment',
    verifiedAt: '2026-09-19',
    schoolYear: '2026-27',
  },
  {
    districtName: 'Dickinson ISD',
    aliases: ['Dickinson Independent School District'],
    enrollmentUrl: 'https://www.dickinsonisd.org/page/parentstudent.enroll',
    sourceLabel: 'Dickinson ISD new student enrollment',
    verifiedAt: '2026-09-19',
    schoolYear: '2026-27',
  },
  {
    districtName: 'Spring ISD',
    aliases: ['Spring Independent School District'],
    enrollmentUrl: 'https://www.springisd.org/registration',
    sourceLabel: 'Spring ISD new student registration',
    verifiedAt: '2026-09-19',
    schoolYear: '2026-27',
  },
  {
    districtName: 'Fort Bend ISD',
    aliases: ['Fort Bend Independent School District'],
    enrollmentUrl: 'https://www.fortbendisd.com/newstudent',
    sourceLabel: 'Fort Bend ISD student enrollment',
    verifiedAt: '2026-09-19',
    schoolYear: '2026-27',
  },
];
