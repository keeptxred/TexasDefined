...
export const TEXAS_KNOWLEDGE_SEED: TexasKnowledgeRecord[] = [
  ...
  },
  {
    ...
    sources: [officialSource('tpwd-snakes','Texas Parks and Wildlife Department','https://tpwd.texas.gov/huntwild/wild/species/')],
  ...
  },
  {
    ...
    sources: [officialSource('tslac-symbols','Texas State Library and Archives Commission','https://www.tsl.texas.gov/ref/abouttx/symbols.html')],
  ...
  },
  {
    ...
    sources: [officialSource('nws','National Weather Service','https://www.weather.gov/safety/hurricane')],
