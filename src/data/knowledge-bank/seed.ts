...
export const TEXAS_KNOWLEDGE_SEED: TexasKnowledgeRecord[] = [
  ...
  },
  {
    ...
    sources: [officialSource('tpwd-wildlife','Texas Parks and Wildlife Department','https://tpwd.texas.gov/huntwild/wild/species/dillo/')],
  ...
  },
  {
    ...
    sources: [officialSource('tpwd-wildlife','Texas Parks and Wildlife Department','https://tpwd.texas.gov/education/resources/texas-junior-naturalists/watching-wildlife/coyote')],
  ...
  },
  {
    ...
    sources: [officialSource('tpwd-wildlife','Texas Parks and Wildlife Department','https://tpwd.texas.gov/education/resources/texas-junior-naturalists/snakes-alive/venomous-snake-safety')],
