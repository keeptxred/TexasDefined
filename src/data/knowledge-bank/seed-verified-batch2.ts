...
export const TEXAS_KNOWLEDGE_VERIFIED_BATCH2: TexasKnowledgeRecord[] = [
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'bobcat Texas habitat',
  ...
  },
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'bobcat Texas',
    socialFormats: ['fact-of-the-day','wildlife-of-the-day','true-or-false'], usage: { timesUsed: 0 },
  },
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'black bear West Texas',
    socialFormats: ['fact-of-the-day','wildlife-of-the-day','true-or-false','texas-trivia'], usage: { timesUsed: 0 },
  },
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'black bear Chisos Mountains Texas',
    socialFormats: ['fact-of-the-day','wildlife-of-the-day','texas-trivia'], usage: { timesUsed: 0 },
  },
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'mountain lion Texas Trans-Pecos',
    socialFormats: ['fact-of-the-day','wildlife-of-the-day','texas-trivia'], usage: { timesUsed: 0 },
  },
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'striped skunk Texas',
    socialFormats: ['fact-of-the-day','wildlife-of-the-day','true-or-false'], usage: { timesUsed: 0 },
  },
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'Virginia opossum Texas',
    socialFormats: ['fact-of-the-day','wildlife-of-the-day','texas-trivia'], usage: { timesUsed: 0 },
  },
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'javelina collared peccary Texas',
    socialFormats: ['fact-of-the-day','wildlife-of-the-day','true-or-false','texas-trivia'], usage: { timesUsed: 0 },
  },
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'nine-banded armadillo Texas',
    socialFormats: ['fact-of-the-day','wildlife-of-the-day','texas-trivia'], usage: { timesUsed: 0 },
  },
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'American alligator East Texas',
    socialFormats: ['fact-of-the-day','wildlife-of-the-day','texas-trivia'], usage: { timesUsed: 0 },
  },
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'American alligator Texas water',
  ...
  },
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'Texas bats evening',
    socialFormats: ['fact-of-the-day','true-or-false','texas-trivia'], usage: { timesUsed: 0 },
  },
  {
    ...
    verification: 'verified', verifiedAt: checkedAt, season: 'summer', evergreen: true, socialReady: true,
    plannedArticlePath: '/texas-wildlife-guide', imageQuery: 'Texas bat colony',
