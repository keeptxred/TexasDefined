...
export const KNOWLEDGE_BANK_SOURCES: KnowledgeBankSource[] = [
  ...
  { id:'tslac', domain:'history', authority:'Texas State Library and Archives Commission', title:'Texas State Library and Archives Commission', url:'https://www.tsl.texas.gov/', useFor:['state symbols','archives','government history','county seats'], canonical:true },
  ...
  { id:'ready-gov', domain:'emergency-management', authority:'Federal Emergency Management Agency / U.S. Department of Homeland Security', title:'Ready.gov', url:'https://www.ready.gov/', useFor:['emergency supply kits','household preparedness','emergency water planning'], canonical:true, notes:'Use claim-specific Ready.gov materials for numeric supply guidance and re-check time-sensitive recommendations before publication.' },
