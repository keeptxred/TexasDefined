...
export const KNOWLEDGE_BANK_SOURCES: KnowledgeBankSource[] = [
  ...
  { id:'tnris', domain:'geography', authority:'Texas Geographic Information Office', title:'Texas Natural Resources Information System', url:'https://www.tnris.org/', useFor:['maps','geography','GIS'], canonical:true },
