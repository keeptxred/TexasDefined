...
export const viatorDestinationExpansionWave12: Destination[] = [
  {
    ...
    summary: "Texas Hill Country Olive Co. is a family-owned Dripping Springs culinary destination built around Texas olive oil, with guided oil-and-balsamic tastings, a public orchard, a gourmet shop and a daytime bistro in the Texas Hill Country.",
    category: "food-bbq",
    region: "hill-country",
    geography: {
    ...
    county: "Hays County",
    coordinates: { lat: 30.257662, lng: -98.127598 },
    address: "2530 W Fitzhugh Rd, Dripping Springs, TX 78620",
    hero: {
      src: "/images/destinations/texas-hill-country-olive-co-ai-illustration.webp",
      alt: "AI editorial illustration representing a Texas Hill Country olive-oil destination in Dripping Springs",
      width: 1024,
      height: 1024,
      credit: "User-provided AI-generated illustration for TexasDefined; not actual-location photography",
    },
