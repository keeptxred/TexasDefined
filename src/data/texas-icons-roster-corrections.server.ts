...
export const TEXAS_ICON_CORRECTED_RESEARCH_PROFILES: readonly TexasIconResearchProfile[] = [
  {
    ...
    publicationNote: "Explicit correction of owner-supplied rank 223 from Trey Parker to Houston-born collaborator Matt Stone. The raw intake remains auditable; this corrected profile remains noindex pending image-rights and internal-link certification.",
