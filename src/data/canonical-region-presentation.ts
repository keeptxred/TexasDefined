...
/** Editorial presentation only. Canonical assignments remain in the geography graph. */
...
export function canonicalRegionPresentation(id: CanonicalPrimaryRegionId) { return presentationById[id]; }
