...
export const majorEventIndexRecords: MajorEventIndexRecord[] = [
  ...
  { slug: "houston-auto-show", name: "Houston Auto Show", city: "Houston", countySlug: "harris", countyName: "Harris County", region: "gulf-coast", category: "culture", startDate: "2027-01-27", endDate: "2027-01-31", venue: "NRG Center", officialUrl: "https://www.houstonautoshow.com/", sourceCheckedAt: "2026-08-27" },
  { slug: "fulton-oysterfest", name: "Fulton Oysterfest", city: "Fulton", countySlug: "aransas", countyName: "Aransas County", region: "gulf-coast", category: "food", startDate: "2027-03-04", endDate: "2027-03-07", venue: "Fulton Harbor Park", officialUrl: "https://fultonoysterfest.org/", sourceCheckedAt: "2026-08-27" },
  { slug: "parker-county-peach-festival", name: "Parker County Peach Festival", city: "Weatherford", countySlug: "parker", countyName: "Parker County", region: "prairies-lakes", category: "food", startDate: "2027-07-10", endDate: "2027-07-10", venue: "Historic Downtown Weatherford", officialUrl: "https://www.parkercountypeachfestival.org/", sourceCheckedAt: "2026-08-27" },
  { slug: "valero-texas-open", name: "Valero Texas Open", city: "San Antonio", countySlug: "bexar", countyName: "Bexar County", region: "south-texas", category: "sport", startDate: "2027-03-29", endDate: "2027-04-04", dateNote: "The official 2027 fact sheet lists tournament week as March 29-April 4; the discovery inventory's April 1-4 range covered only part of the published event week.", venue: "TPC San Antonio", officialUrl: "https://valerotexasopen.com/", sourceCheckedAt: "2026-08-27" },
];
