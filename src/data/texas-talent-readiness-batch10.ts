  ...
  "j-frank-dobie": {
    ...
    imageReview: {
      ...
      heroImage: {
        ...
        credit: "RayAYang / Wikimedia Commons",
        sourceUrl: "https://commons.wikimedia.org/wiki/File:J_Frank_Dobie_House.jpg",
        licenseLabel: "CC BY-SA 3.0",
        licenseUrl: "https://creativecommons.org/licenses/by-sa/3.0/",
        rightsNote: "The Wikimedia-hosted photograph is attributed to RayAYang under CC BY-SA 3.0. Attribution, a license link and compatible share-alike treatment are required for adaptations.",
        kind: "place-context",
        contextNote: "No portrait with equally clear reusable rights was verified. This is Dobie's Austin home, where he wrote and gathered students and colleagues, so the image is intentionally presented as a place-context hero rather than as a portrait.",
      },
    },
    internalLinkReview: {
      status: "partial",
  ...
  "horton-foote": {
    ...
    imageReview: {
      ...
      heroImage: {
        ...
        rightsNote: "Photographer Larry D. Moore publishes the photograph under CC BY 4.0 on Wikimedia Commons. Attribution, a license link and an indication of modifications are required.",
        kind: "place-context",
        contextNote: "Available archival portraits located during review did not carry sufficiently clear reuse permission. Foote repeatedly drew his imaginative world from Wharton, so this rights-cleared hometown image is used transparently as context rather than represented as a portrait.",
      },
    },
    internalLinkReview: {
      status: "partial",
  ...
  "dorothy-hood": {
    ...
    imageReview: {
      ...
      heroImage: {
        ...
        rightsNote: "Photographer Jim Evans publishes this museum exterior under CC BY-SA 4.0 on Wikimedia Commons. Attribution, a license link and compatible share-alike treatment are required for adaptations.",
        kind: "place-context",
        contextNote: "The MFAH portrait is explicitly copyrighted and the Hood archival collection warns that publication rights remain with creators or heirs. Rather than misusing those images, this hero shows the Art Museum of South Texas, which acquired a major portion of Hood's estate and led a major retrospective of her work.",
      },
    },
    internalLinkReview: {
      status: "partial",
  ...
  "donald-judd": {
    ...
    imageReview: {
      ...
      heroImage: {
        ...
        credit: "Paul Joseph / Wikimedia Commons",
        sourceUrl: "https://commons.wikimedia.org/wiki/File:Water_tower_-_Marfa_TX.jpg",
        licenseLabel: "CC BY 2.0",
        licenseUrl: "https://creativecommons.org/licenses/by/2.0/",
        rightsNote: "Wikimedia Commons records Paul Joseph's Marfa photograph under CC BY 2.0. Attribution, a license link and an indication of modifications are required.",
        kind: "place-context",
        contextNote: "Many freely licensed Commons photographs associated with Judd depict his still-copyrighted artworks rather than the artist himself. This avoids that secondary-rights problem by using a rights-cleared image of Marfa, the place at the center of Judd's Texas story, and labeling it explicitly as context.",
      },
    },
    internalLinkReview: {
      status: "partial",
