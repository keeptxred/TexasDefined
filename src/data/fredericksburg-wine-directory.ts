...
export const FREDERICKSBURG_WINE_DIRECTORY: FredericksburgWineDirectoryEntry[] = [
  ...
  { id: "narrow-path-estate", name: "Narrow Path Winery", producer: "Narrow Path Winery", area: "Stonewall", kind: "estate-winery", summary: "Vineyard tasting room south of Stonewall using estate fruit alongside selected Texas and California grapes.", sourceUrl: "https://www.visitfredericksburgtx.com/directory/narrow-path-winery/", sourceLabel: "Visit Fredericksburg", verifiedAt },
  ...
  { id: "fischer-wieser-culinary-tasting-room", name: "Fischer & Wieser Culinary Adventure Tasting Room", area: "Fredericksburg area", kind: "wine-shop", summary: "Wine and specialty-food tasting experience inside the historic Das Peach Haus culinary campus.", sourceUrl: "https://www.visitfredericksburgtx.com/directory/fischer-wieser-culinary-adventure-tasting-room/", sourceLabel: "Visit Fredericksburg", verifiedAt },
  ...
  { id: "arrowhead-creek-vineyards", name: "Arrowhead Creek Vineyards", area: "Stonewall", kind: "estate-winery", summary: "Stonewall-area vineyard offering wine tastings and tours among historic buildings and acres of vines.", sourceUrl: "https://www.visitfredericksburgtx.com/directory/arrowhead-creek-vineyards/", sourceLabel: "Visit Fredericksburg", verifiedAt },
  ...
  { id: "elk-store-winery-distillery", name: "Elk Store Winery & Distillery", area: "Downtown Fredericksburg", kind: "tasting-room", summary: "Main Street wine and spirits destination serving wines from Texas and beyond alongside house-distilled spirits and small plates.", sourceUrl: "https://www.visitfredericksburgtx.com/directory/elk-store-winery-distillery/", sourceLabel: "Visit Fredericksburg", verifiedAt },
  { id: "cuvee-cellars", name: "Cuvée Cellars", area: "Downtown Fredericksburg", kind: "wine-shop", summary: "Fredericksburg wine retailer included by the official visitor bureau among shops that also offer wine tasting experiences.", sourceUrl: "https://www.visitfredericksburgtx.com/things-to-do/wineries/retailers/", sourceLabel: "Visit Fredericksburg", verifiedAt },
  ...
  { id: "six-shooter-cellars", name: "Six Shooter Cellars", area: "Highway 290 / east Fredericksburg", kind: "tasting-room", summary: "Highway 290 tasting room offering classic varietals, dessert wines, honey meads and a large selection of sweet fruit wines.", sourceUrl: "https://www.visitfredericksburgtx.com/directory/six-shooter-cellars/", sourceLabel: "Visit Fredericksburg", verifiedAt },
];
