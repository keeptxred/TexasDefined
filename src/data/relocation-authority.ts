...
export const RELOCATION_PLACES: RelocationPlace[] = [
  ...
  { name: "Hurst", metro: "Dallas–Fort Worth", region: "North Texas", setting: "suburban", planningBand: "balanced", commuteStyle: "corridor", climate: "central", counties: ["Tarrant"], guideHref: "/city/hurst" },
