...
const records: MajorEventAuthorityRecord[] = [
  {
    ...
    endDate: "2027-03-21",
    dateNote: "Visit Granbury lists Founders Day Cook Off on the third weekend in March, and the Historic Granbury Merchants Association currently presents the celebration as a Friday-through-Sunday festival honoring General Granbury's birthday. Applying that recurrence to 2027 yields March 19-21. Recheck the organizer when the dedicated 2027 schedule is released.",
  ...
  },
  {
    ...
    endDate: "2027-06-30",
    dateNote: "Visit Galveston currently publishes Juneteenth Celebrations as a June 1-30, 2027 annual-event window. Individual ceremonies, tours, performances and community events will have their own dates and venues, so check the current program before traveling.",
