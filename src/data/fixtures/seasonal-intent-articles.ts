...
const baseSeasonalIntentArticles: Article[] = [
  ...
  },
  {
    ...
    body: [
      { type: "paragraph", text: "A free Texas Christmas night can be every bit as memorable as a ticketed attraction if you build the evening around public lights, walkable downtowns and community traditions. The key is to separate the event itself from optional spending. A courthouse square may be free to enter even though parking, food, rides, skating, reserved seating or a special attraction nearby costs money. Use the free experience as the anchor, then decide whether any add-on is actually worth paying for." },
