...
export const texasGatewayLifestyleBatch5Articles: Article[] = [
  {
    ...
    internalLinks: [
      ...
      { href: "/article/texas-sayings-outsiders-need-translated", label: "Texas sayings translated" },
    ],
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { href: "/article/things-texas-homeowners-learn-first-year", label: "Texas homeowner lessons" },
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { href: "/article/only-in-texas-weekend-ideas", label: "25 only-in-Texas weekend ideas" },
    ],
    relatedCollections: [], relatedDestinations: [],
  },
  {
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { href: "/article/texas-weather-surprises-newcomers", label: "Texas weather surprises" },
    ],
    relatedCollections: [], relatedDestinations: [],
  },
  {
    ...
    internalLinks: [
      ...
      { href: "/article/things-you-see-on-a-texas-road-trip", label: "Things you notice on a Texas road trip" },
