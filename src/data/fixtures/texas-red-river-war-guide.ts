...
export const texasRedRiverWarGuideArticle: Article = {
  ...
  internalLinks: [
    ...
    { href: "/destination/palo-duro-canyon", label: "Palo Duro Canyon", description: "Visit the landscape of the decisive September 1874 attack and one of the most dramatic public landscapes in the Panhandle." },
  ...
  relatedCollections: [],
  relatedDestinations: ["palo-duro-canyon", "goodnight-ranch"],
  body: [
