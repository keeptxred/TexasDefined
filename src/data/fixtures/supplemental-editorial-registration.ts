...
import { texasDogsEvergreenWave3Articles } from "./texas-dogs-evergreen-wave3";
...
for (const article of [...texasDogsEvergreenArticles, ...texasDogsEvergreenWave2Articles, ...texasDogsEvergreenWave3Articles]) {
