...
export const texasRoofsHailWindHeatArticle: Article = {
  ...
  hero: {
    src: roofHero,
    alt: "A Texas home roof beneath dramatic storm clouds with sunlight breaking through",
    width: 1600,
    height: 1067,
  },
  authorId: "a-marisol",
  ...
  internalLinks: [
    ...
    { href: "/article/prepare-texas-house-freeze", label: "Prepare a Texas house for a freeze", description: "Cold-weather preparation for the systems above and below the roofline." },
  ],
  relatedCollections: [],
  relatedDestinations: [],
  body: [
    ...
    list(
      "Do not walk a steep, wet or storm-damaged roof yourself.",
      "Photograph visible damage from the ground before cleanup begins.",
      "Check attic spaces for fresh stains, damp insulation or daylight where it should not be visible.",
      "If you hire an inspector or roofer, ask for photographs and specific damaged locations rather than a vague replacement recommendation.",
    ),
    ...
    p("After high winds, scan for shingles that look lifted, missing, shifted or unusually shiny where granules have been stripped. Also check gutters, soffits and fascia, because damage at the roof edge can let wind-driven rain reach places that ordinary rainfall never does."),
    ...
    p("Proper attic ventilation and insulation do not make the roof cool, but they can reduce extreme attic temperatures and moisture problems. They also help the house perform better as a system, which matters when air-conditioning equipment is already working hard."),
    p("Heat also punishes sealants, pipe boots and other rubber or plastic components. A roof may still have years left in its shingles while a small penetration gasket has become brittle enough to leak."),
    ...
    p("Roof design, installation details and local wind requirements matter more near the coast. The most important question is not whether a material is marketed as hurricane resistant; it is whether the complete roof assembly was installed for the conditions and code requirements at that address."),

    h("What homeowners should inspect twice a year"),
    list(
      "Missing, lifted, curled or cracked shingles.",
      "Loose ridge caps and flashing around chimneys, walls and roof transitions.",
      "Aging pipe boots and sealant around penetrations.",
      "Gutters pulling away, holding water or discharging too close to the foundation.",
      "Tree limbs touching or scraping the roof.",
      "Stains on ceilings or roof decking in the attic.",
      "Soft spots, sagging or areas where the roof plane no longer looks straight.",
    ),
    ...
    p("Homeowners often ask for a single lifespan number. That number is less useful than people hope. The same roofing product can age differently depending on slope, shade, ventilation, installation quality, storm history, roof orientation and local climate."),
    p("A well-installed roof that has avoided major hail may remain serviceable long after a poorly ventilated or storm-damaged roof of the same age. Keep installation records, permits, invoices and warranty information. When buying a home, ask for the actual roof replacement date rather than relying on a listing description such as 'newer roof.'"),
