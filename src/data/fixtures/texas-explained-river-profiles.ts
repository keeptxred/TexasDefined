...
export const texasGuadalupeRiverGuideArticle: Article = {
  ...
  category: "lakes-rivers",
  hero: { src: "/images/editorial/texas-guadalupe-river.svg", alt: "Clear Guadalupe River flowing beneath mature cypress trees", width: 1600, height: 1115 },
  authorId: "a-marisol", publishedAt: "2026-08-16", readingMinutes: 10,
...
export const texasTrinityRiverGuideArticle: Article = {
  ...
  category: "lakes-rivers",
  hero: { src: "/images/editorial/texas-trinity-river.svg", alt: "Reservoir shoreline and open water in the upper Trinity River basin", width: 1600, height: 1067 },
  authorId: "a-marisol", publishedAt: "2026-08-16", readingMinutes: 10,
