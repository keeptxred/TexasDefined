...
const additions: Record<string, ArticleInternalLink[]> = {
  "best-lighthouses-to-visit-in-texas": [
    ...
    { href: "/destination/port-isabel-lighthouse", label: "Plan the Port Isabel stop", description: "Use the destination guide for the public lighthouse experience, nearby places and current planning context." },
