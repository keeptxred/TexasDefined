...
export const texasFlagHistoryArticle: Article = {
  ...
  hero: {
    src: "https://www.tsl.texas.gov/sites/default/files/public/tslac/exhibits/alacarte/27L_03_Krag.jpg",
    alt: "Peter Krag's original 1839 color design for the Republic of Texas flag and seal, preserved by the Texas State Archives",
    width: 2800,
    height: 2254,
    credit: "Peter Krag / Texas State Library and Archives Commission · 1839 public-domain archival document",
  },
  authorId: "a-marisol",
