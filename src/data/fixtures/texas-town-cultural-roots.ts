...
export const texasTownCulturalRootsArticle: Article = {
  ...
  internalLinks: [
    ...
    { href: "/destination/shiner", label: "Explore Shiner", description: "See Czech and German heritage in one compact town through the brewery, painted church, local museum and railroad-era community." },
    { href: "/destination/spoetzl-brewery", label: "Visit K. Spoetzl Brewery", description: "Connect Central European brewing traditions to a working Shiner brewery and modern visitor destination." },
  ],
  relatedCollections: [], relatedDestinations: ["shiner", "spoetzl-brewery"],
  body: [
    ...
    p("Shiner is one of the clearest compact examples. Its Czech and German community history can be read across the same town through Saints Cyril and Methodius Church, the Spoetzl Brewery, local museum collections and the institutions that grew around the railroad-era settlement."),
