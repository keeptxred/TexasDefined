...
import { texasGatewayOccasionBatch14Articles, loadTexasGatewayOccasionBatch14Article } from "./texas-gateway-occasion-batch14";
...
export const texasCoreArticleStubs: Article[] = [...baseTexasCoreArticleStubs, ...texasGatewayOccasionBatch14Articles];
...
export async function loadTexasCoreArticle(brandId: string, slug: string): Promise<Article | null> {
  ...
  const occasionArticle = loadTexasGatewayOccasionBatch14Article(slug);
  if (occasionArticle) return occasionArticle;
