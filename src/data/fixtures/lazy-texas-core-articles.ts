...
import { texasGatewayLifestyleBatch5Articles, loadTexasGatewayLifestyleBatch5Article } from "./texas-gateway-lifestyle-batch5";
...
export const texasCoreArticleStubs: Article[] = [...baseTexasCoreArticleStubs, ...texasGatewayLifestyleBatch5Articles];
...
export async function loadTexasCoreArticle(brandId: string, slug: string): Promise<Article | null> {
  ...
  const gatewayLifestyleArticle = await loadTexasGatewayLifestyleBatch5Article(brandId, slug);
