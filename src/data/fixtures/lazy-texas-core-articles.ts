...
export const texasCoreArticleStubs: Article[] = [
  ...
  stub({ id: "ar-5", slug: "moving-to-texas-what-nobody-tells-you", title: "What Nobody Tells You About Moving to Texas", dek: "Property tax math, water districts, the summer that never ends, and the case for renting a year before you buy.", category: "moving-to-texas", hero: images.smallTown, authorId: "a-dell", publishedAt: "2026-02-20", readingMinutes: 10, tags: ["moving", "cost of living", "property tax", "relocation"], featured: true, relatedCollections: [], relatedDestinations: ["gruene-historic-district"] }),
  ...
  stub({ id: "ar-7", slug: "texas-dance-hall-survival", title: "The Last Dance Halls", dek: "Nine hundred were built. Fewer than four hundred are standing. What keeps a wooden room with no air conditioning alive in 2026.", category: "texas-history", region: "hill-country", hero: images.smallTown, authorId: "a-hollis", publishedAt: "2026-01-28", readingMinutes: 8, tags: ["history", "music", "dance halls", "preservation"], relatedCollections: [], relatedDestinations: ["gruene-historic-district"] }),
