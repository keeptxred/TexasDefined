...
import { texasGatewayDecisionBatch12Articles, loadTexasGatewayDecisionBatch12Article } from "./texas-gateway-decision-batch12";
...
export const texasCoreArticleStubs: Article[] = [...baseTexasCoreArticleStubs, ...texasGatewayDecisionBatch12Articles];
...
export async function loadTexasCoreArticle(brandId: string, slug: string): Promise<Article | null> {
  ...
  const gatewayArticle = await loadTexasGatewayDecisionBatch12Article(brandId, slug);
