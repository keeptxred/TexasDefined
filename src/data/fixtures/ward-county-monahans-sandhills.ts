...
export const wardCountyMonahansSandhillsArticle: Article = {
  ...
  region: "big-bend",
  hero: {
    src: "https://upload.wikimedia.org/wikipedia/commons/1/18/USA_-_Texas_-_Monahans_Sandhills_State_Park.jpg",
    alt: "Wind-shaped dunes at Monahans Sandhills State Park in Ward County, Texas",
    width: 5344,
    height: 3006,
    credit: "Alexander Hatley · Wikimedia Commons · CC BY 2.0",
  },
  authorId: "a-marisol",
