...
const loaders: Record<string, () => Promise<Article>> = {
  ...
  "texas-dog-lake-river-safety": async () => (await import("./texas-dogs-practical-wave3")).texasDogLakeRiverSafetyArticle,
  "hiking-texas-trails-with-your-dog": async () => (await import("./texas-dogs-practical-wave3")).hikingTexasTrailsWithYourDogArticle,
  "camping-in-texas-with-your-dog": async () => (await import("./texas-dogs-practical-wave3")).campingInTexasWithYourDogArticle,
  "adopting-a-dog-in-texas": async () => (await import("./texas-dogs-practical-wave3")).adoptingADogInTexasArticle,
