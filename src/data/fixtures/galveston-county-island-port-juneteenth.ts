...
export const galvestonCountyIslandPortJuneteenthArticle: Article = {
  ...
  body: [
    ...
    p("That changed in 2022, when Battleship Texas was towed through the Houston Ship Channel to Gulf Copper on Pelican Island. The Battleship Texas Foundation describes the work as a $75 million restoration and museum overhaul. After more than 700 tons of steel had been renewed during the dry-dock phase, the ship was undocked and returned to the water on March 5, 2024; deck, superstructure, preservation and museum work continued afterward."),
    ...
    h("What makes Galveston County distinctive"),
