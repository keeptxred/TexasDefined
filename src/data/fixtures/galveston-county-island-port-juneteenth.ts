...
export const galvestonCountyIslandPortJuneteenthArticle: Article = {
  ...
  dek: "Barrier-island wetlands, historic port streets, mainland industry and fast-growing communities meet in a county shaped by water, storms, medicine and the freedom story that became Juneteenth.",
  ...
  readingMinutes: 6,
  tags: ["Galveston County", "Galveston", "Juneteenth", "Port of Galveston", "Galveston Island State Park", "Texas City", "League City", "UTMB", "Gulf Coast", "Texas counties"],
  featured: false,
  internalLinks: [
    { href: "/destination/galveston-island-state-park", label: "Explore Galveston Island State Park", description: "Beach, prairie, bay wetlands and paddling trails on Galveston Island." },
    { href: "/browse/counties", label: "Browse all 254 Texas counties", description: "Explore Texas one county at a time." },
    { href: "/article/why-texas-has-254-counties", label: "Why Texas has 254 counties", description: "How distance and local government shaped the county map." },
    { href: "/explore/beaches-coast", label: "Explore the Texas coast", description: "More beaches, islands, bays and coastal places." },
  ],
  relatedCollections: [],
  relatedDestinations: ["galveston-island-state-park"],
  body: [
    p("Galveston County is a barrier island facing the Gulf, a working harbor, a bayfront chain of communities, a petrochemical corridor around Texas City and a fast-growing mainland edge tied to Houston. Galveston remains the county seat, but much of the population now lives north of the island around League City, Dickinson, Friendswood and other mainland communities."),
    p("Salt marsh and beach share the map with laboratories, refineries, cruise terminals and suburbs. Water creates opportunity and beauty while determining where people build, how ships move and how seriously residents prepare for hurricanes."),
    ...
    p("Galveston's protected harbor made the island one of nineteenth-century Texas's most important commercial gateways. Cotton, people, mail and manufactured goods moved through its wharves. The Strand's commercial blocks preserve that era; the Texas Historical Commission recognizes the district for national significance in commerce, transportation, government and architecture."),
    ...
    p("Galveston answered with a seawall along the Gulf and by raising large portions of the city with sand pumped beneath buildings and streets. Hurricane Ike in 2008 reinforced the same lesson: the county has never conquered the sea; it has learned to live with a dynamic and hazardous coast."),
    ...
    p("Galveston is the historic and cultural anchor; Texas City is industrial and mainland-oriented; League City is a major growth center; Santa Fe remains more semi-rural; Kemah turns toward boating and Clear Lake; and Bolivar Peninsula adds beaches, fishing communities and a ferry connection to the island. Tourism, port activity, heavy industry, logistics, health care and suburban growth all contribute to the county economy."),
    ...
    p("The coast here is never only scenery. Gulf and bay influence commerce, wildlife, storms, tourism and industry at once. Galveston County is built at the water's edge—historic and modern, vulnerable and resilient, urban and wild."),
  ],
};
