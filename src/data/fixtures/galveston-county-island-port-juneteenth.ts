...
export const galvestonCountyIslandPortJuneteenthArticle: Article = {
  ...
  readingMinutes: 5,
  tags: ["Galveston County", "Galveston", "Juneteenth", "Port of Galveston", "Galveston Island State Park", "Texas City", "UTMB"],
  featured: false,
  internalLinks: [
    ...
    { href: "/article/why-texas-has-254-counties", label: "Why Texas has 254 counties", description: "How the county map formed." },
