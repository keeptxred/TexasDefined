...
export const galvestonCountyIslandPortJuneteenthArticle: Article = {
  ...
  dek: "Barrier-island wetlands, port streets and mainland industry meet in a county shaped by water, storms, medicine and Juneteenth.",
  ...
  readingMinutes: 5,
  tags: ["Galveston County", "Galveston", "Juneteenth", "Port of Galveston", "Galveston Island State Park", "Texas City"],
  featured: false,
  internalLinks: [
  ...
  body: [
    p("Galveston County combines a Gulf barrier island and working harbor with the Texas City industrial corridor and a growing mainland tied to Houston. Galveston remains the county seat, while many residents live north of the island around League City, Dickinson, Friendswood and other communities. Salt marsh, beach, refineries, cruise terminals and suburbs share the county, with water shaping both opportunity and hurricane risk."),
    ...
    p("Few Texas counties place so many state and national stories together: the birthplace of Juneteenth, the memory of the 1900 storm, a historic Gulf port, the state's first medical school, a major industrial corridor and a barrier-island ecosystem still reshaped by wind and water. Gulf and bay influence commerce, wildlife, storms, tourism and industry at once."),
  ],
};
