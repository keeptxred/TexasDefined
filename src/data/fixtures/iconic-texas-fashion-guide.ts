...
export const iconicTexasFashionGuideArticle: Article = {
  ...
  category: "guides",
  hero: {
    src: "https://commons.wikimedia.org/wiki/Special:Redirect/file/Boots_on_the_fence..JPG?width=1600",
    alt: "Cowboy boots displayed on a fence between Marfa and Presidio, Texas",
    width: 1600,
    height: 1200,
    credit: "NorthcottPhotos · CC BY-SA 3.0 · Wikimedia Commons",
  },
  authorId: "a-marisol",
