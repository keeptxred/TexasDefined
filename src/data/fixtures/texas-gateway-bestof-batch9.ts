...
export const texasGatewayBestOfBatch9Articles: Article[] = [
  ...
  article({
    ...
    internalLinks: [{ href: "/destination/shiner", label: "Explore Shiner" }, { href: "/destination/spoetzl-brewery", label: "Visit K. Spoetzl Brewery" }, { href: "/food-bbq", label: "Texas food & BBQ" }, { href: "/road-trips", label: "Texas road trips" }, { href: "/small-towns", label: "Texas small towns" }, { href: "/browse/cities", label: "Browse Texas cities" }, { href: "/events", label: "Texas food festivals and events" }], relatedCollections: [], relatedDestinations: ["shiner", "spoetzl-brewery"],
  }),
];
