...
export const texasRanchToMarketRoadsArticle: Article = {
  ...
  category: "road-trips", hero: { src: "/images/editorial/texas-rm-roads.jpg", alt: "Illustrated two-lane Texas ranch road with an RM highway shield", width: 1600, height: 900 },
...
export const texasLoopsSpursArticle: Article = {
  ...
  category: "road-trips", hero: { src: "/images/editorial/texas-loops-spurs.jpg", alt: "Illustrated Texas interchange with Loop and Spur route shields", width: 1600, height: 900 },
  authorId: "a-marisol", publishedAt: "2026-08-16", readingMinutes: 9,
...
export const texasBusinessRoutesArticle: Article = {
  ...
  category: "road-trips", hero: { src: "/images/editorial/texas-business-routes.jpg", alt: "Illustrated Texas main street with a green business-route highway shield", width: 1600, height: 900 },
  authorId: "a-marisol", publishedAt: "2026-08-16", readingMinutes: 9,
...
export const texasParkRecreationalRoadsArticle: Article = {
  ...
  category: "road-trips", hero: { src: "/images/editorial/texas-park-recreational-roads.jpg", alt: "Illustrated Texas park road entering a wooded recreational area with PR and RE shields", width: 1600, height: 900 },
  authorId: "a-marisol", publishedAt: "2026-08-16", readingMinutes: 9,
...
export const texasHistoricMemorialRoutesArticle: Article = {
  ...
  category: "road-trips", hero: { src: "/images/editorial/texas-historic-memorial-routes.jpg", alt: "Illustrated Texas highway with a brown historic-route sign and memorial-highway plaque", width: 1600, height: 900 },
  authorId: "a-marisol", publishedAt: "2026-08-16", readingMinutes: 9,
