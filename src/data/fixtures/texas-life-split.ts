...
const economyArticle: Article = {
  ...
  internalLinks: [
    ...
    { href: "/article/how-to-choose-electricity-plan-texas", label: "How to choose a Texas electricity plan", description: "Turn the state's power market into a practical household decision when comparing places to live." },
...
const safetyArticle: Article = {
  ...
  internalLinks: [
    ...
    { href: "/article/muds-pids-hoas-special-districts-texas", label: "MUDs, PIDs, HOAs and special districts", description: "Understand who may provide water, drainage and neighborhood services outside a conventional city setup." },
    { href: "/article/buying-land-in-texas-guide", label: "Buying land in Texas", description: "Extend the unincorporated-area checklist to wells, septic, access, utilities, floodplain and restrictions." },
    ...
    { href: "https://www.tdi.texas.gov/tips/fireworks.html", label: "Texas State Fire Marshal fireworks guidance", description: "Check the state's current fireworks safety guidance, including the need to follow local rules and burn bans." },
...
const citiesArticle: Article = {
  ...
  internalLinks: [
    ...
    { href: "/article/muds-pids-hoas-special-districts-texas", label: "MUDs, PIDs, HOAs and special districts", description: "Compare the local entities that can change taxes, utilities and neighborhood costs across metro boundaries." },
    { href: "/article/buying-land-in-texas-guide", label: "Buying land in Texas", description: "Use the rural-property checklist when a city search turns into an acreage or exurban search." },
