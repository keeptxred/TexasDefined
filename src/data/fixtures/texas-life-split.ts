...
const economyArticle: Article = {
  ...
  body: [
    ...
    p("TexasDefined keeps this page practical. Readers who need legal interpretation should consult current Texas statutes, agency guidance or qualified counsel."),
