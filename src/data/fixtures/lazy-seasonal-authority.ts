...
export const seasonalAuthorityArticleStubs: Article[] = [
  ...
  stub({ id: "sa-4", slug: "lost-lighthouses-of-texas", title: "The Lost Lighthouses of Texas", dek: "The Texas lights that disappeared, moved or became obsolete.", category: "texas-history", region: "gulf-coast", hero: heroes.lighthouse, authorId: "a-hollis", publishedAt: "2026-08-20", readingMinutes: 10, tags: [], relatedCollections: [], relatedDestinations: [] }),
  ...
  stub({ id: "sa-6", slug: "best-places-to-see-bluebonnets-in-texas", title: "Where Texas Turns Blue in Spring", dek: "The Texas regions most worth planning around for bluebonnets.", category: "outdoors", hero: heroes.bluebonnets, authorId: "a-dell", publishedAt: "2026-08-20", readingMinutes: 11, tags: [], relatedCollections: ["wildflower-house"], relatedDestinations: ["enchanted-rock"] }),
  stub({ id: "sa-7", slug: "texas-bluebonnet-road-trip", title: "The Bluebonnet Loop We Would Actually Drive", dek: "A practical spring bluebonnet road trip through Central Texas.", category: "road-trips", region: "hill-country", hero: heroes.roadTrip, authorId: "a-dell", publishedAt: "2026-08-20", readingMinutes: 10, tags: [], relatedCollections: [], relatedDestinations: ["enchanted-rock"] }),
  stub({ id: "sa-8", slug: "christmas-in-texas-complete-guide", title: "Christmas in Texas, From River Lights to Courthouse Squares", dek: "Texas Christmas lights, towns, trains and holiday trips.", category: "events", hero: heroes.christmas, authorId: "a-marisol", publishedAt: "2026-08-20", readingMinutes: 15, tags: [], featured: true, relatedCollections: [], relatedDestinations: [] }),
  stub({ id: "sa-9", slug: "best-christmas-towns-in-texas", title: "The Texas Towns That Go All In for Christmas", dek: "Texas towns that transform for the Christmas season.", category: "small-towns", hero: heroes.christmas, authorId: "a-marisol", publishedAt: "2026-08-20", readingMinutes: 10, tags: [], relatedCollections: [], relatedDestinations: [] }),
  stub({ id: "sa-10", slug: "texas-christmas-road-trip", title: "A Hill Country Christmas Road Trip", dek: "A Hill Country holiday loop built around lights and town squares.", category: "road-trips", region: "hill-country", hero: heroes.roadTrip, authorId: "a-dell", publishedAt: "2026-08-20", readingMinutes: 9, tags: [], relatedCollections: [], relatedDestinations: [] }),
  stub({ id: "sa-11", slug: "fall-in-texas-complete-guide", title: "Where Autumn Actually Shows Up in Texas", dek: "Texas fall color, timing, parks and scenic drives.", category: "outdoors", hero: heroes.fall, authorId: "a-hollis", publishedAt: "2026-08-20", readingMinutes: 14, tags: [], featured: true, relatedCollections: [], relatedDestinations: ["caddo-lake"] }),
  stub({ id: "sa-12", slug: "best-places-for-fall-colors-in-texas", title: "The Places We Trust for Texas Fall Color", dek: "The Texas destinations most likely to deliver fall color.", category: "state-parks", hero: heroes.fall, authorId: "a-dell", publishedAt: "2026-08-20", readingMinutes: 10, tags: [], relatedCollections: [], relatedDestinations: ["caddo-lake"] }),
  stub({ id: "sa-13", slug: "texas-fall-foliage-road-trip", title: "A Texas Fall Foliage Road Trip That Works", dek: "A flexible Texas foliage route with Hill Country and East Texas options.", category: "road-trips", region: "hill-country", hero: heroes.roadTrip, authorId: "a-dell", publishedAt: "2026-08-20", readingMinutes: 9, tags: [], relatedCollections: [], relatedDestinations: [] }),
];
