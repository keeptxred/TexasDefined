...
export const texasNationalCemeteriesGuideArticle: Article = {
  ...
  body: [
    ...
    p("Hours and operating policies can change, especially around federal holidays, weather events, road work and special ceremonies. Texas Defined checked the VA visitor information for these three cemeteries on August 29, 2026; verify the official VA cemetery page again before making a special trip."),
