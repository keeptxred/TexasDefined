...
export const mudsPidsHoasSpecialDistrictsArticle: Article = {
  ...
  internalLinks: [
    ...
    { href: "/property-tax-calculators", label: "Texas property-tax calculators", description: "Model exemptions, protests, escrow and other household property-tax scenarios." },
    { href: "/texas-property-tax-county-comparison-calculator", label: "Compare property taxes by county", description: "Put local tax assumptions into a side-by-side county comparison before narrowing a home search." },
    { href: "/texas-homeownership-cost-calculator", label: "Texas homeownership cost calculator", description: "Combine the mortgage with taxes, insurance, utilities, maintenance and recurring ownership costs." },
