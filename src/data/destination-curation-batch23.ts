...
const curated: Record<string, Partial<Destination>> = {
  ...
  "battleship-texas": {
    summary: "Commissioned in 1914, USS Texas (BB-35) is the world's only surviving dreadnought-era battleship and a veteran of both World Wars, now undergoing restoration in Galveston for a permanent museum home at Pier 15.",
    ...
    highlights: [
      ...
      "Major Galveston restoration and future permanent Pier 15 berth",
    ],
    body: [
      ...
      "For the complete ship history—from the first battleship named Texas through BB-35's 1914 commissioning, both World Wars, D-Day, museum preservation and the Galveston restoration—use the TexasDefined Battleship Texas history feature and verify current access through the Foundation before traveling specifically to board the ship.",
    ],
  ...
  "battleship-texas-state-historic-site": {
    ...
    highlights: ["Historic Battleship Texas", "Ongoing Galveston restoration", "Future Pier 15 museum berth", "Former San Jacinto site no longer the ship's location"],
    body: [
