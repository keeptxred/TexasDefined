...
export const paintedChurchSymbols: PaintedChurchSymbol[] = [
  ...
  },
  {
    ...
    churchSlugs: ["high-hill-nativity-of-mary", "moravia-ascension-of-our-lord", "mason-st-joseph-catholic-church"],
    sourceLabel: "Austin PBS — Symbols in the Painted Churches",
    sourceUrl: PBS_SYMBOLS,
  ...
  },
  {
    ...
    churchSlugs: ["dubina-saints-cyril-methodius", "praha-st-marys-assumption", "bandera-st-stanislaus-catholic-church", "plantersville-st-marys-catholic-church", "mason-st-joseph-catholic-church"],
