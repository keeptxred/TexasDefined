...
import { wildseedFarmsFredericksburgDestinations } from "./wildseed-farms-fredericksburg-destination";
...
import { statewideMuseumExpansionWave38Destinations } from "./museum-expansion-statewide-wave38";
...
import { statewideMuseumExpansionWave43Destinations } from "./museum-expansion-statewide-wave43";
import { statewideMuseumExpansionWave44Destinations } from "./museum-expansion-statewide-wave44";
import { statewideMuseumExpansionWave45Destinations } from "./museum-expansion-statewide-wave45";
import { statewideMuseumExpansionWave46Destinations } from "./museum-expansion-statewide-wave46";
import { statewideMuseumExpansionWave47Destinations } from "./museum-expansion-statewide-wave47";
import { statewideMuseumExpansionWave48Destinations } from "./museum-expansion-statewide-wave48";
...
import { smallTownWave4Destinations } from "./small-town-destinations-wave4";
import { smallTownWave5Destinations } from "./small-town-destinations-wave5";
...
import { wildlifeManagementAreaWave9Destinations } from "./wildlife-management-area-destinations-wave9";
...
export const preservedExploreDestinations = mergePreservedDestinations(
  ...
  wildseedFarmsFredericksburgDestinations,
  ...
  statewideMuseumExpansionWave38Destinations,
  ...
  statewideMuseumExpansionWave43Destinations,
  statewideMuseumExpansionWave44Destinations,
  statewideMuseumExpansionWave45Destinations,
  statewideMuseumExpansionWave46Destinations,
  statewideMuseumExpansionWave47Destinations,
  statewideMuseumExpansionWave48Destinations,
  ...
  smallTownWave3Destinations,
  smallTownWave4Destinations,
  smallTownWave5Destinations,
