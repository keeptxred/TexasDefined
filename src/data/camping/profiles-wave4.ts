...
export const CAMPING_PROFILES_WAVE4: CampingProfile[] = [
  {
    ...
    amenities: ["electric-30", "electric-50", "water-hookup", "sewer-hookup", "full-hookup", "restrooms", "showers", "pets", "swimming", "lake-access", "fishing"],
  ...
  },
  {
    ...
    amenities: ["electric-30", "electric-50", "water-hookup", "sewer-hookup", "full-hookup", "restrooms", "showers", "pets", "swimming", "lake-access", "fishing", "hiking"],
  ...
  },
  {
    ...
    amenities: ["electric-30", "electric-50", "water-hookup", "sewer-hookup", "full-hookup", "restrooms", "showers", "pets", "swimming", "river-access", "gulf-access", "fishing"],
