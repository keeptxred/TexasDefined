...
export const CAMPING_PROFILES_WAVE5: CampingProfile[] = [
  ...
  },
  {
    ...
    styles: ["tent"],
    amenities: ["water-hookup", "lake-access", "hiking"],
    ...
    campingNotes: [
      ...
      "Water is supplied from two centrally located hydrants and portable toilet facilities serve the area.",
    ...
    verifiedAt: VERIFIED_AT,
    sources: [{ label: "SRA-TX Lakeview Campground", url: "https://sratx.org/parks-and-recreation/lakeview/", fields: ["10 campsites", "tent pads", "water hydrants", "portable toilets", "Trail Between the Lakes", "USFS ownership", "SRA-TX operation"] }],
  },
  {
