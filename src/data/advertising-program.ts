...
// Contract text and the accepted-agreement snapshot generator intentionally stay
// server-only in advertiser-agreement-content.server.ts to keep legal copy out of the client bundle.
