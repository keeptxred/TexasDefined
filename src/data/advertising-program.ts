...
export const advertiserTiers = [
  {
    ...
    monthlyPrice: 249,
    annualPrice: 2490,
    shortDescription: 'For a local business that wants a professional presence beside a highly relevant Texas guide or destination.',
  ...
  },
  {
    ...
    features: [
      ...
      'Monthly performance summary',
      'Up to two coordinated social support placements per month when campaign creative is suitable',
      'Up to one clearly labeled sponsored feature per quarter, subject to editorial/commercial review',
  ...
  },
  {
    ...
    monthlyPrice: null,
    annualPrice: null,
    shortDescription: 'For event campaigns, seasonal programs, section sponsorships, agencies and custom statewide partnerships.',
    bestFor: 'Large campaigns, tourism organizations, agencies, custom seasonal programs and category sponsorships.',
    commitment: 'Defined in the order form or insertion order.',
    features: [
...
export const agreementClauses = [
  ...
  {
    heading: '2. Services and placement',
  ...
  {
    heading: '4. Fees, invoices and payment',
  ...
  {
    heading: '5. Advertiser materials and license',
  ...
  {
    heading: '6. Editorial independence and disclosure',
  ...
  {
    heading: '7. Advertising claims and prohibited material',
  ...
  {
    heading: '8. No performance guarantee',
  ...
  {
    heading: '9. Creative deadlines and delays',
  ...
  {
    heading: '11. Publisher make-goods',
  ...
  {
    heading: '13. Confidential information',
  ...
  {
    heading: '19. Independent contractors',
  ...
  {
    heading: '21. Notices',
    body: 'Operational notices may be sent to the business email addresses used for the campaign. Formal breach, cancellation or legal notices should be sent to the addresses stated in the order form or other written account records.',
  },
  {
  ...
  {
    heading: '23. Entire agreement and changes',
  ...
  {
    heading: '24. Electronic signatures',
