...
export const TEXAS_HOCKEY_TEAMS: readonly TexasHockeyTeam[] = [
  ...
  },
  {
    ...
    homeVenueName: 'George’s Pond at Hirsch Coliseum',
    officialUrl: 'https://goetbutigers.com/sports/mens-ice-hockey',
    sourceUrl: 'https://www.etbu.edu/life-hill/get-involved/family-weekend', sourceLabel: 'ETBU 2026 Family Weekend / hockey home site',
    overview: 'East Texas Baptist is a current TCHC member program in ACHA Men’s Division 2. The university is in Marshall, Texas, while its 2026 home hockey schedule is based at George’s Pond at Hirsch Coliseum in Shreveport, Louisiana.',
    travelNote: 'Do not plan this hockey trip around Marshall lodging alone: ETBU states that its 2026 home hockey games are played at George’s Pond in Shreveport, Louisiana. Verify the specific game before travel.',
    seasonNote: 'ETBU’s 2026 Family Weekend guidance says all Tigers hockey home games are played at George’s Pond in the Hirsch Coliseum in Shreveport, Louisiana.',
  },
  {
