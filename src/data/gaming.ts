...
const quakeCon = { label: "QuakeCon — official event information", url: "https://quakecon.bethesda.net/en/", kind: "company" as const };
const texasTechEsportsMinor = { label: "Texas Tech — Esports Minor", url: "https://www.depts.ttu.edu/comc/about/news/posts/2026/03/battle-for-the-806.php", kind: "university" as const };
const texasWesleyanEsportsMinor = { label: "Texas Wesleyan — Esports Minor", url: "https://txwes.edu/academics/artssciences/undergraduate-minors/esport-minor/", kind: "university" as const };
...
export const COLLEGE_ESPORTS = [
  ...
  { school: "Baylor University", city: "Waco", status: "Varsity + academy + student club", detail: "Baylor operates varsity teams, an academy development tier and the student-led Oso Esports club. Baylor says the varsity program began national competition in the 2025–26 academic year.", url: "https://esports.web.baylor.edu/" },
  { school: "Texas Wesleyan University", city: "Fort Worth", status: "Varsity esports + Esports & Gaming program", detail: "Texas Wesleyan fields varsity esports teams and runs a broader Esports & Gaming program built around competition, content creation, community and career development.", url: "https://txwes.edu/student-life/get-involved/esports-and-gaming/" },
  { school: "Lubbock Christian University", city: "Lubbock", status: "Athletic esports program", detail: "LCU describes esports as an athletic program launched in 2020, with current competitive teams and dedicated coaching.", url: "https://esports.lcu.edu/" },
  { school: "The University of Texas at Tyler", city: "Tyler", status: "Program with varsity-level teams", detail: "UT Tyler says its esports program competes with varsity-level teams across multiple titles and operates an esports lab supported by campus departments.", url: "https://www.uttyler.edu/student-life/esports/" },
  { school: "Texas Tech University", city: "Lubbock", status: "Competitive sport club + academic esports minor", detail: "Texas Tech University Recreation lists the Tech Esports Association as a competitive sport club, while the College of Media & Communication launched a separate esports minor in 2026.", url: "https://www.depts.ttu.edu/recreation/sportclubs/clubs.php" },
  { school: "Texas State University", city: "San Marcos", status: "Student esports club + dedicated campus arena", detail: "Texas State identifies the TXST Esports Arena in the LBJ Student Center as the official arena for the Texas State Esports Club.", url: "https://www.lbjsc.txst.edu/about/maps-and-hours.html" },
] as const;
...
export const GAMING_PAGES: GamingPage[] = [
  ...
  },
  {
    ...
    sections: [
      { title: "Varsity versus club", paragraphs: ["TexasDefined uses each institution's own language rather than treating every competitive team as varsity. UT Dallas, UNT and Baylor explicitly describe varsity competition; Texas Wesleyan fields varsity esports teams; UT Tyler says it competes with varsity-level teams; Lubbock Christian describes an athletic esports program. Texas Tech and Texas State are represented as clubs, while Texas A&M's official directory describes A&M Esports as a student organization.", "Scholarships, supported games, conferences and team rosters can change by academic year. Follow the official program link for current details."] },
      { title: "Facilities and production", paragraphs: ["UT Dallas's Comets LANding is a notable example of esports expanding beyond competition into broadcast production, events and community gaming. Texas State identifies a dedicated campus arena for its esports club, while UT Tyler operates an esports lab. These spaces matter for students interested in production, social media, event operations and facility management as well as playing."] },
      { title: "Academic pathways", paragraphs: ["Competition is only one path into the field. Texas Tech announced an esports minor in March 2026, and Texas Wesleyan offers an esports minor focused on areas such as event management, content creation, branding, analytics and audience engagement. TexasDefined keeps academic programs separate from team status so a degree or minor is not mistaken for a varsity designation."] },
    ],
    sources: [utd, uta, unt, tamu, texasTechEsportsMinor, texasWesleyanEsportsMinor],
    related: [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "QuakeCon has a durable Texas identity", paragraphs: ["Bethesda describes QuakeCon as its annual BYOC LAN party. The 2026 edition ran August 6–9 at Gaylord Texan Resort & Convention Center in Grapevine, with tournaments, free play, meetups, tabletop gaming and community programming. Because the 2026 dates are now past, TexasDefined treats them as historical context and sends readers to the official QuakeCon site for the next announced edition instead of rolling the dates forward automatically."] },
    ...
    sources: [arlingtonVenue, utd, quakeCon, { label: "DreamHack — 2026 U.S. festival location update", url: "https://dreamhack.com/blog/2025/11/02/a-message-to-the-community/", kind: "company" }],
    related: [
