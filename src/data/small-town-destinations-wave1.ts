...
export const smallTownWave1Destinations: Destination[] = [
  {
    ...
    areaGuide: {
      ...
      foodAndDrink: [
        { name: "Fredericksburg winery & tasting-room directory", description: "Use the structured TexasDefined directory above to compare source-checked estate wineries, Highway 290 properties, Stonewall and Hye producers, and distinct downtown tasting rooms without confusing one location type for another.", proximity: "On this page", href: "#fredericksburg-wine-directory" },
        { name: "Main Street dining and German-Texan food", description: "Restaurants, bakeries, cafes and bars make the historic core the easiest park-once food district.", proximity: "Downtown" },
        ...
        { name: "Fredericksburg Brewing Company", description: "Long-running Main Street brewpub and an easy non-wine option in the historic core.", proximity: "Downtown", href: "https://www.yourbrewery.com/" },
        { name: "Das Peach Haus & Fischer & Wieser", description: "Specialty-food, orchard and culinary campus with tastings and a wine-focused tasting room.", proximity: "South Fredericksburg", href: "https://www.daspeachhaus.com/" },
        ...
        { name: "Elk Store Winery & Distillery", description: "Main Street distillery and tasting stop serving small-batch spirits, cocktails, wine and small plates.", proximity: "Downtown", href: "https://www.visitfredericksburgtx.com/things-to-do/distilleries/" },
        { name: "1693 Distillery", description: "Fredericksburg distillery connecting modern spirits with the owner's nineteenth-century German family history.", proximity: "Luckenbach Road", href: "https://www.visitfredericksburgtx.com/directory/1693-distillery/" },
        ...
        { name: "Belly Up Brew Pub", description: "Downtown-adjacent craft brewpub with food.", proximity: "Central Fredericksburg", href: "https://www.visitfredericksburgtx.com/directory/belly-up-brew-pub/" },
        { name: "Iron Goat Distillery", description: "Family- and veteran-owned craft distillery making rum, agave spirit and honey spirit just north of Main Street.", proximity: "Downtown", href: "https://www.visitfredericksburgtx.com/directory/iron-goat-distillery/" },
        { name: "Salvation Spirits & Speakeasy", description: "Fruit-focused craft spirits and cocktails on a Highway 290 orchard property; verify current renovation and private-class availability before visiting.", proximity: "Highway 290", href: "https://www.visitfredericksburgtx.com/directory/salvation-speakeasy/" },
        { name: "Lincoln Street Wine Market", description: "Long-running downtown wine and cigar bar with a patio, food and regular live music.", proximity: "Downtown / Warehouse District", href: "https://www.visitfredericksburgtx.com/directory/lincoln-street-wine-market/" },
        { name: "Western Edge Cellars", description: "Downtown wine-bar and nightlife stop identified by the official visitor bureau among Fredericksburg's late-night options.", proximity: "Downtown", href: "https://www.visitfredericksburgtx.com/things-to-do/music-nightlife/bars/" },
        { name: "Hye Cider Company", description: "Cider alternative in the Hye and Stonewall corridor.", proximity: "Hye", href: "https://www.visitfredericksburgtx.com/listing/hye-cider-company/3101/" },
      ],
      lodging: [
