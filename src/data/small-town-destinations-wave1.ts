...
export const smallTownWave1Destinations: Destination[] = [
  {
    ...
    areaGuide: {
      ...
      foodAndDrink: [
        ...
        { name: "Messina Hof Hill Country", description: "Hill Country location of the long-running Texas winery group.", proximity: "Wine Road 290", href: "https://messinahof.com/" },
        ...
        { name: "Texas Hills Vineyard", description: "Johnson City winery on the eastern wine-country route.", proximity: "Johnson City", href: "https://www.texashillsvineyard.com/" },
        ...
        { name: "Mendelbaum Cellars", description: "Highway 290 tasting room with wines from Texas and Israel.", proximity: "Wine Road 290", href: "https://www.visitfredericksburgtx.com/directory/mendelbaum-cellars/" },
