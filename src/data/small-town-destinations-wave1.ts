...
export const smallTownWave1Destinations: Destination[] = [
  {
    ...
    areaGuide: {
      ...
      foodAndDrink: [
        ...
        { name: "Altstadt Brewery", description: "German-inspired brewery and food destination west of town for groups that want an alternative to wine.", proximity: "West of Fredericksburg", href: "https://www.altstadtbeer.com/" },
