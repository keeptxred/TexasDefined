...
export const smallTownWave1Destinations: Destination[] = [
  {
    ...
    areaGuide: {
      ...
      foodAndDrink: [
        ...
        { name: "Messina Hof Hill Country", description: "Destination-style Highway 290 winery with an onsite vineyard, broad Texas-wine portfolio, light bites and four Manor Haus cottages.", proximity: "Wine Road 290", href: "/destination/messina-hof-hill-country" },
