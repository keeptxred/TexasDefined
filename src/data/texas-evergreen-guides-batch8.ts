...
export const TEXAS_EVERGREEN_GUIDES_BATCH8: Record<string, TexasEvergreenGuide> = {
  ...
  "texas-birds-guide": {
    ...
    sections: [
      ...
      { heading: "Birding trips", body: ["The Rio Grande Valley, Gulf Coast, Hill Country, Big Bend region and East Texas each offer distinct birding experiences. Build a trip around habitat and season rather than a generic statewide checklist.", "State parks, refuges and wildlife-management areas can provide both access and educational resources."], links: [{ href: "/destination/hazel-bazemore-county-park", label: "Hazel Bazemore hawk migration" }, { href: "/explore/outdoors", label: "Explore Texas outdoors" }, { href: "/explore", label: "Explore Texas" }] }
    ],
    related: [
      ...
      { href: "/destination/hazel-bazemore-county-park", label: "Corpus Christi HawkWatch", description: "Plan a fall raptor-migration visit at Hazel Bazemore County Park." },
