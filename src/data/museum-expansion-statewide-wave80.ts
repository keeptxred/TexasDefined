...
import { statewideMuseumExpansionWave81Destinations } from "./museum-expansion-statewide-wave81";
...
/**
 * Eightieth statewide museum wave. This record gives Brenham's active
 ...
 */
export const statewideMuseumExpansionWave80Destinations: Destination[] = [
  {
    id: "museum-statewide-wave80-brenham-heritage-museum",
    ...
    entryNote: "The museum currently lists regular hours Tuesday through Saturday from 10 a.m. to 4 p.m. Walk-ins are welcome, with separate admission rates by age and group type. Guided tours are available by appointment, and free parking plus a rear ramp and elevator support wheelchair and stroller access.",
    highlights: [
    ...
    body: [
      "Brenham Heritage Museum occupies a building that already tells part of the city's story. Construction on the federal post office began in 1914 and was completed in 1916; the building served as Brenham's primary post office until the mid-1960s before taking on other federal uses. The City of Brenham later made the landmark available in 1991 for local museum use, and the nonprofit museum organization developed it into a center for interpreting Brenham and Washington County history.",
  ...
  ...statewideMuseumExpansionWave81Destinations,
];
