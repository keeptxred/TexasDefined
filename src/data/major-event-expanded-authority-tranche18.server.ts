...
const records: MajorEventAuthorityRecord[] = [
  {
    ...
    endDate: "2027-04-24",
    dateNote: "The official LJT Fest site confirms the 38th annual festival for April 19-24, 2027 in Stephenville. Use the organizer's current calendar for the flagship festival and its separate Coastin' & Cruisin' event schedule when planning a Galveston-linked trip.",
    ...
    planningSections: [
      { title: "Use the organizer's confirmed six-day window", body: "The official festival site lists April 19-24, 2027 and already has festival tickets and open-camping reservations on sale. Use those published dates as the authoritative planning window and recheck the organizer before travel." },
