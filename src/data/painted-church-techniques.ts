...
export const paintedChurchTechniques: PaintedChurchTechnique[] = [
  {
    ...
    answer: "Stenciling uses a reusable template cut with a pattern. The template is placed against the wall or ceiling, paint is applied through the openings, and the template is removed to leave a crisp repeating design. Texas Painted Churches use stenciling for borders, ceiling fields and ornamental bands.",
  ...
  },
  {
    ...
    answer: "Infill is a variation on stenciling. Instead of painting directly through the whole template, the artist transfers an outline and then fills the design by hand. It is useful for larger repeating motifs and can produce more shading and variation than plain stenciling.",
  ...
  },
  {
    ...
    answer: "Freehand painting covers individualized representational or ornamental work painted without a repeating stencil. In the Painted Churches it includes sacred scenes, angels, floral ornament and architectural imagery whose composition is unique to a particular surface.",
  ...
  },
  {
    slug: "marbling",
    name: "Marbling",
    shortDefinition: "Paint used to imitate costly polished marble.",
    answer: "Marbling is hand-painted faux stone. Decorative painters used layered color and veining to make inexpensive wood or plaster resemble marble, allowing rural congregations to create the visual richness of European churches without the cost and weight of real stone.",
    ...
    whatToLookFor: ["Columns that look like stone but are structurally wood", "Vein-like lines and mottled color", "Different faux-marble colors used to distinguish architectural elements"],
    sourceLabel: "Austin PBS — Decorative Painting Techniques",
    sourceUrl: PBS_TECHNIQUES,
    churchSlugs: ["high-hill-nativity-of-mary", "ammannsville-st-john-the-baptist", "moravia-ascension-of-our-lord", "wallis-guardian-angel", "sweet-home-queen-of-peace", "shiner-saints-cyril-methodius", "bandera-st-stanislaus-catholic-church"],
  ...
  },
  {
    ...
    answer: "Graining is faux wood painting. Artists used brushes, combs or rollers to imitate the grain of expensive woods such as mahogany or rosewood on cheaper local materials, especially doors, moldings, baseboards and furnishings.",
    ...
    whatToLookFor: ["Painted grain that repeats more regularly than natural wood", "Dark faux-wood doors or moldings", "Decorative wood effects on inexpensive pine or cedar"],
    sourceLabel: "Austin PBS — Decorative Painting Techniques",
    sourceUrl: PBS_TECHNIQUES,
    churchSlugs: [],
  ...
  },
  {
    ...
    answer: "Architectural illusion uses perspective, shadow, painted joints and faux architectural elements to make a simple surface appear vaulted, columned or spatially deeper than it really is. High Hill and Wesley show two very different uses of this eye-fooling strategy.",
    howItWorks: ["Painted ribs, joints, columns or openings imitate three-dimensional architecture.", "Shadows and perspective create apparent depth.", "The painted system visually upgrades a simpler timber interior into a more elaborate European-style space."],
    whatToLookFor: ["Vault ribs that are paint rather than masonry", "Painted columns or arches on flat walls", "False apses, openings or stonework"],
    sourceLabel: "Austin PBS — High Hill and Wesley",
    sourceUrl: "https://austinpbs.org/paintedchurches/highhill",
    churchSlugs: ["high-hill-nativity-of-mary", "wesley-brethren-church"],
