...
export const MADE_IN_TEXAS_ENTRIES: TexasMadeEntry[] = [
  ...
  entry('All Seasons Feeders', 'San Antonio', 'bexar', 'home-outdoors', 'made-or-processed', 'All Seasons Feeders labels its feeders and blinds as built or made in Texas and operates from San Antonio.'),
  entry('Texas Hunter Products', 'San Antonio', 'bexar', 'home-outdoors', 'made-or-processed', 'Texas Hunter Products manufactures feeders, blinds and outdoor equipment and operates from San Antonio.'),
  ...
  entry('Waterloo Rods', 'Victoria', 'victoria', 'home-outdoors', 'made-or-processed', 'Waterloo says it builds high-performance fishing rods from its shop in Victoria, Texas.'),
  ...
  entry('Pecos cantaloupe tradition', 'Pecos', 'reeves', 'food-drink', 'founded', 'The nationally known commercial Pecos cantaloupe tradition originated around Pecos in Reeves County; modern commercial Pecos cantaloupe production is largely outside the city.'),
  entry('Texas Rio Red grapefruit', 'Rio Grande Valley', 'hidalgo', 'food-drink', 'made-or-processed', 'Texas Red grapefruit is commercially produced in the Lower Rio Grande Valley.'),
