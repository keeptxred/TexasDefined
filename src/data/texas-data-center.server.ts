...
export const TEXAS_DATASETS: TexasDataset[] = [
  ...
  },
  {
    ...
    description: 'Current Census Vintage 2025 Texas population change and components for 2024–2025.',
    ...
    methodology: 'Vintage 2025 covers July 1, 2024–July 1, 2025. Net migration is a balance, not total movers; revisions can create residual differences, and older vintages are superseded.',
    rows: [
      { label: 'Texas population — July 1, 2025', value: 31709821, note: 'Resident population estimate.' },
      { label: 'Numeric population growth — 2024 to 2025', value: 391243, note: 'Largest numeric state gain.' },
      { label: 'Net domestic migration', value: 67299, note: 'Net interstate gain.' },
  ...
  },
  {
    ...
    description: 'The 2023–2024 period restated on Census Vintage 2025 for consistent historical comparison.',
    category: 'Relocation and migration', year: 2024, updated: '2026-08-27', unit: 'count',
    sourceName: 'U.S. Census Bureau, Vintage 2025 Population Estimates',
    sourceUrl: 'https://www.census.gov/data/datasets/time-series/demo/popest/2020s-state-total.html',
    methodology: 'This 2024 URL now uses Vintage 2025 so comparisons share one series; older vintages are superseded. Use the 2025 brief for the current estimate.',
    rows: [
      { label: 'Texas population — July 1, 2024', value: 31318578, note: 'Revised Vintage 2025 estimate.' },
      { label: 'Numeric population growth — 2023 to 2024', value: 598297, note: 'Vintage 2025 series.' },
