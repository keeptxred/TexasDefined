...
export const TEXAS_HOME_NATURE_CLUSTERS: TexasContentCluster[] = [
  {
    id: 'hurricane-preparedness', title: 'Texas Hurricane Preparedness', hubPath: '/guides/texas-hurricane-preparedness', section: 'Home & Garden', publicationState: 'staged',
  ...
  },
  {
    ...
    sourceIds: ['texas-am-agrilife','texas-am-fire-ants'], plannedCrossLinkTargets: ['/home-garden','/county','/texas-wildlife'], seasonal: ['spring','summer','fall'],
  },
  {
    id: 'texas-snakes', title: 'Texas Snakes', hubPath: '/guides/texas-snakes', section: 'Outdoors', publicationState: 'staged',
    ...
    sourceIds: ['tpwd-wildlife','texas-am-agrilife'], plannedCrossLinkTargets: ['/outdoors','/state-parks','/county'], seasonal: ['spring','summer','fall'],
  },
  {
    id: 'texas-wildlife', title: 'Texas Wildlife', hubPath: '/guides/texas-wildlife', section: 'Outdoors', publicationState: 'staged',
    ...
    sourceIds: ['tpwd-wildlife','texas-am-agrilife'], plannedCrossLinkTargets: ['/outdoors','/state-parks','/county','/explore'],
  },
  {
    id: 'texas-birds', title: 'Texas Birds', hubPath: '/guides/texas-birds', section: 'Outdoors', publicationState: 'staged',
    ...
    sourceIds: ['tpwd-wildlife','ebird','usfws-birds'], plannedCrossLinkTargets: ['/outdoors','/state-parks','/explore','/county'], seasonal: ['spring','fall'],
  },
  {
    id: 'texas-flowers', title: 'Texas Flowers and Native Plants', hubPath: '/guides/texas-flowers', section: 'Explore Texas', publicationState: 'staged',
    ...
    sourceIds: ['tpwd-plants','texas-am-agrilife'], plannedCrossLinkTargets: ['/explore','/road-trips','/state-parks','/county'], seasonal: ['spring','summer'],
  },
];
