...
const records: MajorEventAuthorityRecord[] = [
  ...
  },
  {
    ...
    planningSections: [
      { title: "Westfest 2027 dates: use September 3-5 as the planning window", body: "The organizer describes Westfest as an annual Labor Day Weekend event. Texas Defined maps the standing Friday-through-Sunday pattern to September 3-5, 2027, but the organizer has not yet published the dedicated 2027 program. Treat these dates as a recurrence-derived planning window until that update appears." },
