...
export const TEXAS_DATA_SOURCES: TexasDataSource[] = [
  ...
  { id:'texas-metro-planning', domain:'places', authority:'Texas Department of Transportation', title:'Texas metropolitan planning organizations', url:'https://www.txdot.gov/projects/planning/transportation-planning-organizations.html', format:'html', updateCadence:'quarterly', canonical:true, notes:'Use TxDOT metropolitan-planning references to anchor metro-scale regional planning context; city and county jurisdiction remains represented by its own canonical entity.' },
