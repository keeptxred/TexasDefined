...
export const TEXAS_DATA_SOURCES: TexasDataSource[] = [
  ...
  { id:'uil-football-scoreboard', domain:'sports', authority:'University Interscholastic League', title:'UIL Texas Scoreboard for football schedules and scores', url:'https://www.uiltexas.org/maxpreps/scoreboard', format:'html', updateCadence:'daily', canonical:true, notes:'UIL scoreboard powered by MaxPreps submissions. Use for current football weekly schedules and reported scores; disclose that completeness depends on school and coach participation, and do not represent the feed as official district standings.' },
