...
export const TEXAS_DATA_SOURCES: TexasDataSource[] = [
  ...
  { id:'uil-football-enrollment-cutoffs', domain:'sports', authority:'University Interscholastic League', title:'2026–28 football conference and division enrollment cutoffs', url:'https://www.uiltexas.org/athletics/conference-cutoffs', format:'html', updateCadence:'as-needed', canonical:true, notes:'Use for the enrollment ranges behind 1A–6A and the 1A–5A Division I/II football splits; do not present classification order as a program-quality ranking.' },
  { id:'uil-football-scoreboard', domain:'sports', authority:'University Interscholastic League', title:'UIL Texas Scoreboard and MaxPreps football reporting partnership', url:'https://www.uiltexas.org/athletics/uil-maxpreps', format:'html', updateCadence:'daily', canonical:true, notes:'Use for current UIL football scores and weekly schedules. UIL states the feed depends on school and coach submissions to MaxPreps and does not currently provide standings; do not infer certified district standings from incomplete scoreboard data.' },
  { id:'uil-football-calendar', domain:'sports', authority:'University Interscholastic League', title:'2026–27 UIL football calendar and season dates', url:'https://www.uiltexas.org/football', format:'html', updateCadence:'seasonal', canonical:true, notes:'Use for preseason dates, the 11 possible playing weeks, the November 7 district-certification deadline, playoff week windows and the December 16–19 state-championship window. Individual school game dates still require school or district confirmation.' },
