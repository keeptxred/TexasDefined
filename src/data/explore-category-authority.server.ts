...
import type { ExploreAuthorityGuide } from "./explore-category-authority";
...
export function getExploreCategoryAuthorityServer(category: CategorySlug): ExploreAuthorityGuide | null {
  return exploreCategoryAuthorityServer[category] ?? null;
}
