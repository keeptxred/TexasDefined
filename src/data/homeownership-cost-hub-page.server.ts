const localHousingLocations = [
  { name: 'Houston', slug: 'houston', ownershipHref: '/texas-homeownership-cost-calculator/houston' },
  { name: 'Austin', slug: 'austin', ownershipHref: '/texas-homeownership-cost-calculator/austin' },
  { name: 'Dallas', slug: 'dallas', ownershipHref: '/texas-homeownership-cost-calculator/dallas' },
  { name: 'Fort Worth', slug: 'fort-worth', ownershipHref: '/texas-homeownership-cost-calculator/fort-worth' },
  { name: 'San Antonio', slug: 'san-antonio', ownershipHref: '/texas-homeownership-cost-calculator/san-antonio' },
  { name: 'Frisco', slug: 'frisco', ownershipHref: '/texas-homeownership-cost-calculator/frisco' },
  { name: 'El Paso', slug: 'el-paso', ownershipHref: '/texas-homeownership-cost-calculator/el-paso' },
  { name: 'Harris County', slug: 'harris-county', ownershipHref: '/texas-homeownership-cost-calculator/harris-county' },
  { name: 'Dallas County', slug: 'dallas-county', ownershipHref: '/texas-homeownership-cost-calculator/dallas-county' },
  { name: 'Tarrant County', slug: 'tarrant-county', ownershipHref: '/texas-homeownership-cost-calculator/tarrant-county' },
  { name: 'Bexar County', slug: 'bexar-county', ownershipHref: '/texas-homeownership-cost-calculator/bexar-county' },
  { name: 'Travis County', slug: 'travis-county', ownershipHref: '/texas-homeownership-cost-calculator/travis-county' },
  { name: 'Collin County', slug: 'collin-county', ownershipHref: '/texas-homeownership-cost-calculator/collin-county' },
  { name: 'Denton County', slug: 'denton-county', ownershipHref: '/texas-homeownership-cost-calculator/denton-county' },
  { name: 'Fort Bend County', slug: 'fort-bend-county', ownershipHref: '/texas-homeownership-cost-calculator/fort-bend-county' },
  { name: 'Montgomery County', slug: 'montgomery-county', ownershipHref: '/texas-homeownership-cost-calculator/montgomery-county' },
  { name: 'Williamson County', slug: 'williamson-county', ownershipHref: '/texas-homeownership-cost-calculator/williamson-county' },
  { name: 'El Paso County', slug: 'el-paso-county', ownershipHref: '/texas-homeownership-cost-calculator/el-paso-county' },
  { name: 'Hidalgo County', slug: 'hidalgo-county', ownershipHref: '/texas-homeownership-cost-calculator/hidalgo-county' },
] as const;
...
export function loadHomeownershipCostHubPageServer() {
  return {
    ...
    local: {
      ...
      cards: localHousingLocations.map(({ name, slug, ownershipHref }) => ({
        name,
        ownershipHref,
