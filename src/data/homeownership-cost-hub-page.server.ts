...
export function loadHomeownershipCostHubPageServer() {
  return {
    ...
    local: {
      ...
      copy: 'The planning categories are the same statewide, but the inputs are not. Choose a city or county on each canonical calculator to load researched local context without creating a separate indexable calculator page for every location.',
