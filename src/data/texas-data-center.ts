...
export const TEXAS_DATASETS: TexasDataset[] = [
  ...
  },
  {
    ...
    description: 'Current Census Vintage 2025 Texas population and 2024–2025 components of change.',
    ...
    methodology: 'Census Vintage 2025 is the current consistent series; older vintages are superseded. Values cover July 1, 2024–July 1, 2025. Domestic migration is net, and components can differ from total change because of residual and revision accounting.',
    rows: [
  ...
  },
  {
    ...
    description: 'Revised 2023–2024 Texas change on Census Vintage 2025 for consistent historical comparison.',
    category: 'Relocation and migration', year: 2024, updated: '2026-08-27', unit: 'count',
    sourceName: 'U.S. Census Bureau, Vintage 2025 Population Estimates',
    sourceUrl: 'https://www.census.gov/data/datasets/time-series/demo/popest/2020s-state-total.html',
    methodology: 'This historical 2024 URL is retained for continuity. All values use Vintage 2025; older vintages are superseded. Use the 2025 snapshot for current Texas population.',
    rows: [
      { label: 'Texas population — July 1, 2024', value: 31318578 },
      { label: 'Numeric population growth — 2023 to 2024', value: 598297 },
      { label: 'Net domestic migration', value: 86067 },
      { label: 'Net international migration', value: 354864 },
