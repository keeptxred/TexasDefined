...
export const majorEventSchemaEnrichmentBatch18: MajorEventSchemaEnrichment[] = [
  {
    ...
    image: {
      url: "https://texasdefined.com/images/events/the-texas-relays.jpg",
      alt: "AI-generated photorealistic editorial depiction representing The Texas Relays in Texas",
      sourceUrl: "https://texasdefined.com/images/events/the-texas-relays.jpg",
  ...
  },
  {
    ...
    image: {
      url: "https://texasdefined.com/images/events/worlds-championship-bar-b-que-contest.jpg",
      alt: "AI-generated photorealistic editorial depiction representing Worlds Championship Bar B Que Contest in Texas",
      sourceUrl: "https://texasdefined.com/images/events/worlds-championship-bar-b-que-contest.jpg",
      sourceType: "ai-generated",
      rightsNote: "Generated by TexasDefined with Cloudflare Workers AI (FLUX.1 schnell) for TexasDefined-owned editorial use; no third-party source image was used.",
      exactLocation: false,
      approvedForCommercialUse: true,
