...
export const TEXAS_NATURE_ENTITIES: TexasEntityRecord[] = [
  ...
  official({id:'cavern:natural-bridge-caverns',kind:'cavern',name:'Natural Bridge Caverns',slug:'natural-bridge-caverns',aliases:[],countySlug:'comal',region:'hill-country',coordinates:{latitude:29.6926,longitude:-98.3427},officialUrl:'https://naturalbridgecaverns.com/',sourceId:'official-destination-sites',status:'active',relationships:[{type:'located-in-county',targetId:'county:comal'}],tags:['cavern','attraction','destination-owner']}),
  official({id:'beach:padre-island-national-seashore',kind:'beach',name:'Padre Island National Seashore',slug:'padre-island-national-seashore',aliases:['PINS'],countySlug:'nueces',region:'gulf-coast',coordinates:{latitude:27.107,longitude:-97.354},officialUrl:'https://www.nps.gov/pais/',sourceId:'nps-texas',status:'active',relationships:[{type:'located-in-region',targetId:'region:gulf-coast'}],tags:['beach','national-seashore','wildlife','destination-owner']}),
];

export const TEXAS_TOURISM_ENTITIES: TexasEntityRecord[] = [
  official({id:'historic-site:the-alamo',kind:'historic-site',name:'The Alamo',slug:'the-alamo',aliases:['Alamo Mission'],countySlug:'bexar',region:'south-texas',coordinates:{latitude:29.4257,longitude:-98.4861},officialUrl:'https://www.thealamo.org/',sourceId:'official-destination-sites',status:'active',relationships:[{type:'located-in-city',targetId:'city:san-antonio'},{type:'located-in-county',targetId:'county:bexar'}],tags:['history','mission','battlefield','destination-owner']}),
