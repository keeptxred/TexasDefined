...
export const paintedChurchImageAcquisitionLeads: PaintedChurchImageAcquisitionLead[] = [
  ...
  },
  {
    ...
    subject: "interior",
    label: "St. Joseph Mason parish remodel and history photography",
    sourceUrl: "https://stjosephmason.org/photoalbums/st-joseph-church-remodel-2024",
    sourceOwner: "St. Joseph Catholic Church — Mason",
    status: "permission-needed",
  ...
  },
  {
    churchSlug: "mason-st-joseph-catholic-church",
    subject: "interior",
    label: "St. Joseph Mason preservation-project photography",
    sourceUrl: "https://www.studioiodesign.com/st-joseph-mason",
    sourceOwner: "StudioIO Design",
    status: "permission-needed",
  ...
  },
  {
    churchSlug: "mason-st-joseph-catholic-church",
    subject: "exterior",
    label: "St. Joseph Mason Texas Time Travel photograph",
    sourceUrl: "https://texastimetravel.com/directory/st-josephs-catholic-church/",
    sourceOwner: "Texas Time Travel / underlying photographer",
    status: "rights-unclear",
    nextAction: "Trace the photograph to its creator and original rights statement before publication. Do not infer reusable rights from its presence on the THC tourism site.",
    note: "Exact current church image and useful visitor evidence; tourism publication does not itself grant reuse rights.",
  },
  {
    churchSlug: "mason-st-joseph-catholic-church",
    subject: "exterior",
    label: "Original Texas Defined field photograph",
    sourceUrl: "https://texasdefined.com/explore/painted-churches/mason-st-joseph-catholic-church",
    sourceOwner: "Texas Defined",
    status: "fieldwork-needed",
