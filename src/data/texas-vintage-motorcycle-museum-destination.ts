...
export const texasVintageMotorcycleMuseumDestinations: Destination[] = [
  {
    ...
    highlights: [
      ...
      "Rare American, British, European and Japanese machines, including a 1931 Harley-Davidson and 1968 BMW R60 highlighted by the local visitor guide",
      "Motorcycle art, memorabilia, period display material and an onsite leather boutique",
    ...
    body: [
      ...
      "The motorcycles are the main event. The museum's current venue material describes a roughly 5,000-square-foot showroom with more than 100 vintage motorcycles, while the museum's core story emphasizes machines from the 1950s, 1960s and 1970s. Explore Johnson City's current visitor guide highlights examples ranging from a 1931 Harley-Davidson to a 1968 BMW R60 and rare European racing bikes. Together they show a major transition in motorcycle design, engineering and culture as American, British, European and Japanese manufacturers reshaped the market.",
