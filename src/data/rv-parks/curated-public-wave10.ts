...
const WAVE10: Record<(typeof RV_PARK_CURATED_PUBLIC_WAVE10_SLUGS)[number], CuratedUpdate> = {
  ...
  "loyd-park-rv-campground": {
    summary: "Loyd Park on Joe Pool Lake is a City of Grand Prairie campground with more than 200 wooded campsites, including full-hookup RV options, showers, restrooms, trails, a boat ramp and swimming beach.",
    ...
    entryNote: "Reserve the exact campsite class through the City of Grand Prairie before arrival. The city advertises full-hookup RV sites as part of the park's 221-site campground; verify current utility details, rig fit, lake notices and any temporary ramp or beach restrictions for the booked dates.",
    highlights: [
      "221 wooded campsites advertised by the city",
      "Full-hookup RV site options",
      "Joe Pool Lake boat ramp and swimming beach",
      "Trails, showers, restrooms and lake recreation",
    ],
    body: [
      "Loyd Park is Grand Prairie's developed campground on Joe Pool Lake. Current city materials describe 221 private campsites and specifically advertise full-hookup RV sites, while the park page emphasizes large wooded campsites with picnic facilities and access to showers and restrooms. The mix gives RV travelers a public lake-park setting rather than a parking-lot-style overnight stop.",
  ...
  "vineyards-campground-and-cabins": {
    ...
    body: [
      ...
      "The campground is at 1501 N. Dooley Street in Grapevine. Current policy lists RV check-in at 2 p.m. and checkout at noon, and the reservation system may change the exact site location while preserving the booked site type and amenities unless the guest locks a site. Recheck those policies before travel because rates and operating details can change. The existing Texas Defined hero remains a clearly labeled representative editorial image and therefore does not yet qualify this page for indexing.",
    ],
  ...
  "coleto-creek-regional-park-rv-area": {
    ...
    entryNote: "GBRA lists 59 full-hookup campsites and 20 multi-use sites with water and electricity. Site reservations can be made in advance; late arrivals should contact the park by noon on the arrival day for accommodation because gate and office hours vary seasonally.",
    highlights: [
  ...
  "matagorda-bay-nature-park-rv-resort": {
    ...
    bestSeason: "The park operates year-round, but coastal heat, wind, tropical weather and burn restrictions can change trip conditions quickly. Cooler fall-through-spring weather is often easier for birding, paddling and shoreline time.",
    entryNote: "LCRA currently lists 34 standard full-hookup RV sites, five pull-through full-hookup sites and 15 waterfront RV sites, all with 30/50-amp service. Check active park alerts, burn bans and coastal-weather conditions before arrival.",
    highlights: [
      ...
      "Showers, boat ramp, fishing pier, Wi-Fi and watercraft rentals",
    ],
    body: [
      "Matagorda Bay Nature Park is an LCRA coastal park where the Colorado River meets the Gulf of Mexico. LCRA currently lists 34 full-hookup RV sites, five pull-through full-hookup sites and 15 waterfront RV sites. All three RV classes list 30/50-amp service, and the waterfront sites add shade structures. That gives travelers a choice between standard, pull-through and waterfront layouts instead of one uniform campground product.",
      "The park's location is the main reason to stay. Visitors can reach the Gulf beach, Colorado River, wetlands and paddling areas from the same property, with birding, boating, fishing, kayaking, wildlife viewing, mini golf and picnicking also listed by LCRA. On-site facilities include flushing restrooms, showers, a boat ramp, fishing pier, Wi-Fi, gift shop and watercraft rentals, making it possible to spend much of a coastal trip on park property.",
      "LCRA lists the park at 6420 FM 2031 in Matagorda and posts live notices on the park page. The current page warns of beach-restoration work and active burn restrictions, illustrating why travelers should recheck conditions close to departure. Reserve the exact RV site class that fits the rig and trip goals. Texas Defined's current hero remains labeled representative editorial imagery, so this page stays noindex until the final-image gate is satisfied.",
    ],
