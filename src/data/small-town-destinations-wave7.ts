...
export const smallTownWave7Destinations: Destination[] = [
  {
    ...
    highlights: ["Old Blanco County Courthouse", "Blanco State Park", "Blanco River", "Real Ale Brewing Company", "historic square", "Hill Country craft", "walkable downtown"],
    body: [
    ...
    areaGuide: {
      ...
      nearbyAttractions: [{ name: "Old Blanco County Courthouse", description: "The restored limestone courthouse is Blanco's visual center and a useful starting point for the town's civic history.", href: "/destination/old-blanco-county-courthouse" }, { name: "Blanco State Park", description: "A compact in-town state park focused on the Blanco River, with recreation dependent on current water and weather conditions.", href: "/destination/blanco-state-park" }, { name: "Real Ale Brewing Company", description: "Working Blanco brewery and distillery with a taproom, beer garden, free Friday tours, onsite food and live music.", href: "/destination/real-ale-brewing-company-blanco" }],
