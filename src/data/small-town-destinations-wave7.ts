...
export const smallTownWave7Destinations: Destination[] = [
  {
    ...
    highlights: ["Old Blanco County Courthouse", "Blanco State Park", "Blanco River", "Buggy Barn Museum", "Milam & Greene Whiskey", "Twin Sisters Dance Hall", "Real Ale Brewing Company", "historic square", "Hill Country craft", "walkable downtown"],
    body: [
      ...
      "Blanco also supports a deeper heritage-and-craft loop than the square alone suggests. Buggy Barn Museum preserves more than 250 horse-drawn vehicles and the Pine Moore Old West Studio, Milam & Greene adds a working whiskey distillery and tasting room, and Twin Sisters Dance Hall south of town keeps the Hill Country public-dance tradition alive on a nineteenth-century community floor."
    ],
    ...
    areaGuide: {
      ...
      nearbyAttractions: [{ name: "Old Blanco County Courthouse", description: "The restored limestone courthouse is Blanco's visual center and a useful starting point for the town's civic history." }, { name: "Blanco State Park", description: "A compact in-town state park focused on the Blanco River, with recreation dependent on current water and weather conditions.", href: "/destination/blanco-state-park" }, { name: "Buggy Barn Museum", description: "More than 250 historic buggies, carriages and wagons plus Pine Moore Old West Studio.", href: "/destination/buggy-barn-museum-blanco" }, { name: "Milam & Greene Whiskey", description: "Working whiskey distillery and tasting room with tours, flights, cocktails and Blanco-only releases.", href: "/destination/milam-greene-whiskey-distillery-blanco" }, { name: "Twin Sisters Dance Hall", description: "Historic nineteenth-century dance hall south of town with monthly public dances and special events.", href: "/destination/twin-sisters-dance-hall-blanco" }, { name: "Real Ale Brewing Company", description: "Working Blanco brewery and distillery with a taproom, beer garden, free Friday tours, onsite food and live music.", href: "/destination/real-ale-brewing-company-blanco" }],
