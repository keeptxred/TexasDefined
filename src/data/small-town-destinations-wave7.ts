...
export const smallTownWave7Destinations: Destination[] = [
  {
    ...
    highlights: ["Old Blanco County Courthouse", "Blanco State Park", "Blanco River", "Buggy Barn Museum", "Twin Sisters Dance Hall", "Real Ale Brewing Company", "historic square", "Hill Country craft", "walkable downtown"],
    body: [
      ...
      "Blanco's beverage-production story is deeper than one stop. Real Ale Brewing Company combines a working brewery and distillery with more than 16 taps, Blanco-only pilot releases, food, music and free Friday production tours. Milam & Greene operates its whiskey distillery and tasting room on Carlie Lane, while Andalusia Whiskey Co. produces grain-to-glass Texas whiskey north of town and offers tasting-room visits and reservation-based tours. Together they make Blanco unusually strong for travelers who want to connect Hill Country food-and-drink tourism with actual local production rather than only retail tasting rooms."
    ],
    officialUrl: "https://www.visitblancotexas.com/", sourceCheckedAt: "2026-09-24",
    ...
    areaGuide: {
      ...
      nearbyAttractions: [{ name: "Old Blanco County Courthouse", description: "The restored limestone courthouse is Blanco's visual center and a useful starting point for the town's civic history.", href: "/destination/old-blanco-county-courthouse" }, { name: "Blanco State Park", description: "A compact in-town state park focused on the Blanco River, with recreation dependent on current water and weather conditions.", href: "/destination/blanco-state-park" }, { name: "Buggy Barn Museum", description: "A 250+ vehicle horse-drawn transportation collection paired with the Pine Moore Old West film-set complex.", href: "/destination/buggy-barn-museum-blanco" }, { name: "Twin Sisters Dance Hall", description: "A still-operating nineteenth-century dance hall south of town with first-Saturday public dances and special events.", href: "/destination/twin-sisters-dance-hall-blanco" }, { name: "Real Ale Brewing Company", description: "Working Blanco brewery and distillery with a taproom, beer garden, free Friday tours, onsite food and live music.", href: "/destination/real-ale-brewing-company-blanco" }],
      foodAndDrink: [{ name: "Courthouse square and US 281 corridor", description: "The main concentration of local cafes, restaurants and visitor services." }, { name: "Real Ale Taproom & Beer Garden", description: "Blanco-made beer and spirits, taproom-only pilot releases, pizza and a shaded outdoor gathering space.", proximity: "North US 281", href: "/destination/real-ale-brewing-company-blanco" }, { name: "Milam & Greene Whiskey", description: "A Blanco whiskey distillery and tasting room with current public tasting-room hours and bookable distillery experiences.", proximity: "208 Carlie Lane", href: "https://milamandgreenewhiskey.com/pages/visit-us" }, { name: "Andalusia Whiskey Co.", description: "A grain-to-glass Blanco distillery focused on Texas whiskey, with a public tasting room and tours by reservation.", proximity: "North U.S. 281", href: "https://www.andalusiawhiskey.com/contact" }],
      ...
      familyStops: [{ name: "Buggy Barn Museum", description: "Historic vehicles and the Pine Moore Old West setting make this one of Blanco's strongest family history stops.", href: "/destination/buggy-barn-museum-blanco" }, { name: "Blanco State Park", description: "A strong family outdoor stop when current river conditions are suitable.", href: "/destination/blanco-state-park" }],
    ...
    authorityGuide: {
      ...
      sources: [{ label: "Visit Blanco Texas", url: "https://www.visitblancotexas.com/", scope: "Official visitor information, courthouse, river and destination planning" }, { label: "City of Blanco attractions", url: "https://www.cityofblancotx.gov/1248/Attractions", scope: "Current city attractions and park context" }, { label: "Real Ale Brewing — Taproom & Beer Garden", url: "https://realalebrewing.com/taproom-and-beer-garden/", scope: "Current brewery visitor hours, free Friday tours, taproom, food, family and live-music details" }, { label: "Milam & Greene — Visit Blanco", url: "https://milamandgreenewhiskey.com/pages/visit-us", scope: "Current Blanco tasting-room hours, address and distillery visitor planning" }, { label: "Andalusia Whiskey Co. — Contact", url: "https://www.andalusiawhiskey.com/contact", scope: "Current Blanco tasting-room hours, address and reservation-based tour policy" }]
    }, featured: true
  },
  {
