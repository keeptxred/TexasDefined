...
export const smallTownWave7Destinations: Destination[] = [
  {
    ...
    highlights: ["Old Blanco County Courthouse", "Blanco State Park", "Blanco River", "Real Ale Brewing Company", "Buggy Barn Museum", "Blanco Lavender Festival", "historic square", "Hill Country craft", "walkable downtown"],
    body: [
      ...
      "Real Ale Brewing Company adds a third major visitor anchor north of the historic core. The working brewery and distillery pairs more than 16 taps and Blanco-only pilot releases with a shaded beer garden, onsite food, live music and free Friday production tours, giving the town a direct Made-in-Texas manufacturing stop rather than only restaurants and retail.",
      "Buggy Barn Museum adds one of the town's strongest indoor history stops, with more than 250 historic buggies, carriages and wagons plus Pine Moore Old West Studio. Blanco's signature annual event layer is just as important: the Blanco Lavender Festival returns June 4-6, 2027, centered on the historic courthouse grounds, with the 2027 daily programming still to be published by the organizer."
    ],
    officialUrl: "https://www.visitblancotexas.com/", sourceCheckedAt: "2026-09-20",
    ...
    areaGuide: {
      ...
      nearbyAttractions: [{ name: "Old Blanco County Courthouse", description: "The restored limestone courthouse is Blanco's visual center and a useful starting point for the town's civic history." }, { name: "Blanco State Park", description: "A compact in-town state park focused on the Blanco River, with recreation dependent on current water and weather conditions.", href: "/destination/blanco-state-park" }, { name: "Real Ale Brewing Company", description: "Working Blanco brewery and distillery with a taproom, beer garden, free Friday tours, onsite food and live music.", href: "/destination/real-ale-brewing-company-blanco" }, { name: "Buggy Barn Museum", description: "More than 250 historic buggies, carriages and wagons plus Pine Moore Old West Studio on North Main Street.", href: "/destination/buggy-barn-museum-blanco" }, { name: "Blanco Lavender Festival", description: "Blanco's signature lavender festival returns June 4-6, 2027 around the historic courthouse grounds.", href: "/event/blanco-lavender-festival" }],
      ...
      familyStops: [{ name: "Blanco State Park", description: "A strong family outdoor stop when current river conditions are suitable." }, { name: "Buggy Barn Museum", description: "A highly visual transportation-history museum and Old West studio that works well for multigenerational groups.", href: "/destination/buggy-barn-museum-blanco" }],
