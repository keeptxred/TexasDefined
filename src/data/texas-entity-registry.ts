...
export const CORE_TEXAS_AGENCIES: TexasEntityRecord[] = [
  ...
  {id:'agency:texas-attorney-general',kind:'agency',name:'Office of the Attorney General of Texas',slug:'texas-attorney-general',aliases:['Texas Attorney General','Office of the Texas Attorney General','Texas OAG'],officialUrl:'https://www.texasattorneygeneral.gov/',description:'The Office of the Attorney General represents the State of Texas in legal matters and administers public-facing programs including child-support enforcement, consumer protection, crime-victim services and open-government resources.',tags:['attorney general','child support','consumer protection','open government','crime victims'],sourceId:'texas-agencies',sourceConfidence:'official',sourceCheckedAt:'2026-08-20',status:'active',relationships:[]},
