...
export const paintedChurchPeople: PaintedChurchPerson[] = [
  ...
  },
  {
    ...
    roles: ["artist", "decorator"],
    answer: "Godfrey (Gottfried) Flury was a Swiss-born decorative painter and commercial artist who moved to Moulton in 1892 and was commissioned in 1895 to decorate St. Mary's Church of the Assumption at Praha.",
    significance: ["The Handbook of Texas identifies Praha as Flury's most important church commission.", "Its description ties him to the sky-blue ceiling, trompe-l'oeil ribs and Gothic capitals, floral and gold-scroll ornament, and symbolic imagery throughout the sanctuary.", "Flury's authorship was authenticated in 1972 through surviving preliminary sketches and notes that correspond to the interior, giving the attribution a documentary basis beyond later tourism tradition."],
    ...
    sourceLabel: "Handbook of Texas — Godfrey Flury",
    sourceUrl: "https://www.tshaonline.org/handbook/entries/flury-godfrey",
  },
  {
    slug: "john-f-bujnoch",
    name: "John F. Bujnoch",
