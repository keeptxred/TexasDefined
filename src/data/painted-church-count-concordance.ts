...
export const paintedChurchCountConcordance: PaintedChurchCountConcordanceEntry[] = [
  ...
  },
  {
    ...
    interpretation: "This is a journalistic statewide count using a broader surviving-tradition definition, not an official register total. Its numeric total happens to match Texas Defined's current verified count, but Texas Defined does not assume the two projects contain the same 32 buildings without a church-by-church concordance.",
  ...
  {
    id: "texas-defined-verified",
    label: "Texas Defined verified statewide reference set",
    countText: "32 verified churches",
    numericCount: 32,
