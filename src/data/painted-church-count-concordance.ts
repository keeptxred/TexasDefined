...
export const paintedChurchCountConcordance: PaintedChurchCountConcordanceEntry[] = [
  ...
  },
  {
    ...
    interpretation: "This is a journalistic statewide count using a broader surviving-tradition definition, not an official register total. The article does not expose a complete 32-name statewide roster, so Texas Defined does not reverse-engineer or imply a church-by-church equivalence with its independently verified corpus.",
