...
import { FISHING_ACCESS_DIRECTORY_PATH, FISHING_LOCAL_VERIFIED_AT, FISHING_SERVICES_DIRECTORY_PATH } from "./local-routing";
...
export const FISHING_SITEMAP_ENTRIES = [
  ...
  { path: FISHING_ACCESS_DIRECTORY_PATH, lastmod: FISHING_LOCAL_VERIFIED_AT },
