...
export const TEXAS_TALENT_LAUNCH_DEPTH_WAVE5_REPAIR: Readonly<Record<string, TexasTalentDepthOverride>> = {
  ...
  "tommy-lee-jones": {
    overview: [
      ...
      "For Texas Defined, Jones offers one of the richest film profiles for connecting biography to the state's geography. San Saba, Midland and Dallas describe the personal route; South Texas ranching and border interests extend the connection into adulthood; and projects such as Lonesome Dove and Three Burials provide cultural links to western and border narratives. The page should avoid collapsing actor and character into one identity, but it can accurately show how Jones repeatedly chose work that made use of a Texas-inflected authority, landscape awareness and interest in the American West. That recurring regional engagement distinguishes his Texas connection from birthplace alone.",
    ],
  },
};
