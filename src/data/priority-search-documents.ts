...
export function buildPrioritySearchDocuments(): SearchDocument[] {
  ...
  return [
    ...
    { id: "collection:swimming-holes-river-tubing", brandId: "texasdefined", kind: "collection", title: "Texas Swimming Holes & River Tubing", summary: "Texas swimming holes, spring-fed pools, tubing and float trips.", keywords: ["Texas swimming holes", "Texas river tubing", "Texas tubing", "Texas float trips", "spring-fed swimming"], href: "/explore/swimming-holes-river-tubing" },
