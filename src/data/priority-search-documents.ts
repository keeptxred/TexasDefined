...
export function buildPrioritySearchDocuments(): SearchDocument[] {
  ...
  return [
    ...
    { id: "guide:best-camping-texas", brandId: "texasdefined", kind: "guide", title: "Texas Camping & RV Campground Guide", summary: "Find verified public camping in Texas by RV, tent, primitive, beach, full-hookup, water access and region, with official reservation sources.", keywords: ["best places to go camping in Texas", "best camping in Texas", "Texas camping", "Texas campgrounds", "Texas state park camping", "RV camping Texas", "RV camping near Austin", "RV camping near Dallas", "campgrounds near DFW", "campgrounds near Houston", "RV camping near Waco", "tent camping Texas", "primitive camping Texas", "Texas beach camping", "full hookup public campgrounds", "full hookup campgrounds near Dallas", "full hookup campgrounds near Waco", "lake camping Texas", "river camping Texas", "Inks Lake camping", "Colorado Bend camping", "Caprock Canyons camping", "Dinosaur Valley camping", "Pedernales Falls camping", "Lake Whitney camping", "Lake Tawakoni camping"], href: "/best-places-to-go-camping-in-texas" },
