  ...
  nav: [
    ...
    { label: "Music", to: "/texas-music", description: "Texas music history, roots, genres, artists and places" },
    {
      ...
      children: [
        ...
        { label: "Texas Resources", to: "/texas-resources", description: "Driver licenses, DMV, state agencies and practical services", image: { src: texasCounties, alt: "Texas county map context for state and local resources" } },
