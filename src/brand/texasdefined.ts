...
import nativePlants from "@/assets/generated/texas-native-plants-yard-unique.jpg";
import texasCounties from "@/assets/why-texas-has-254-counties-photo.jpg";
...
export const texasDefinedBrand: BrandConfig = {
  ...
  nav: [
    ...
    { label: "Music", to: "/texas-music", description: "Texas music history, roots, genres, artists and places" },
    {
      ...
      children: [
        { label: "Things That Define Texas", to: "/things-unique-to-texas", description: "250 foods, places, traditions and symbols that define Texas", image: { src: bluebonnets, alt: "Texas bluebonnets representing familiar state traditions and landscapes" } },
        { label: "Texas Icons", to: "/texas-icons", image: { src: sixFlagsHero, alt: "Historic Texas flags and symbols" } },
        { label: "Homes & Land", to: "/real-estate", description: "Buying and owning Texas homes and land", image: { src: heroHillCountry, alt: "Texas Hill Country land in evening light" } },
        { label: "Property", to: "/property", description: "Taxes, exemptions, county guides and homeowner tools", image: { src: courthouseSquare, alt: "Texas courthouse square representing county property services" } },
        ...
        { label: "Texas vs Every State", to: "/texas-vs-every-state", description: "Compare Texas with all 49 other states using one consistent framework", image: { src: bigBend, alt: "Wide West Texas landscape representing the scale of the state" } },
        { label: "Texas Resources", to: "/texas-resources", description: "Driver licenses, DMV, state agencies and practical services", image: { src: texasCounties, alt: "A historic red sandstone Texas county courthouse on a small-town square" } },
        { label: "Home & Garden", to: "/home-garden", description: "Texas homes, yards, seasons and practical projects", image: { src: nativePlants, alt: "Native Texas plants in a home landscape" } },
