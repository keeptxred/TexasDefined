  ...
  return <Container className="pb-16 pt-12 sm:pb-24 sm:pt-16">
    <article className="mx-auto max-w-6xl">
      ...
      <section className="py-10">
        ...
        <p className="mt-4 max-w-4xl text-sm leading-7 text-muted-foreground">The finder covers every current UIL football program with classification, football division, district, six-man or 11-man format, and TEA school/ISD/county context where the records match. The supplied 250-position research list now adds 242 canonical school profiles with enrollment research steps, county and ISD connections, sourced mascot identity where verified, and a path for non-UIL programs that does not mislabel them as UIL schools. The finder also adds an official-UIL recent state-final window from 2018–19 through 2025–26 and lets families compare up to three programs side by side. Full season-by-season records, current schedules, standings and coaching continuity remain future layers until they can be maintained from reliable sources.</p>
