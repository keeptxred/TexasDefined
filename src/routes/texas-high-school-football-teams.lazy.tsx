  ...
  return <Container className="pb-16 pt-12 sm:pb-24 sm:pt-16">
    <article className="mx-auto max-w-6xl">
      ...
      <section className="py-10">
        ...
        <p className="mt-4 max-w-4xl text-sm leading-7 text-muted-foreground">The finder covers every current UIL football program with classification, football division, district, six-man or 11-man format, and TEA school/ISD/county context where the records match. It adds official UIL all-time state-title and state-final totals, keeps detailed recent state-final results from 2018–19 through 2025–26, lets families compare up to three programs side by side, and now links every program to a permanent profile with district peers plus enrollment and UIL-eligibility research guidance. Full season-by-season records, current schedules, standings, verified mascots and coaching continuity remain future layers until they can be maintained from reliable sources.</p>
