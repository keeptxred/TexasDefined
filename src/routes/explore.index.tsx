...
export const EXPLORE_CATEGORIES = ["lakes-rivers", "major-springs", "swimming-holes-river-tubing", "state-parks", "national-parks", "rv-parks", "caverns", "beaches-coast", "historic-sites", "road-trips", "small-towns", "food-bbq", "outdoors"] as const;
