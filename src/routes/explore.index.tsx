...
export const Route = createFileRoute("/explore/")({
  head: ({ loaderData }: { loaderData?: { categories: Category[]; regions: Region[]; destinations: Destination[]; articles: Article[] } }) => {
    ...
    const items = [
      ...
      { "@type": "CollectionPage" as const, name: "Texas Tours & Experiences", description: "Statewide Texas tours, tickets and bookable experience markets covering sightseeing, history, food, wine, water, outdoor, Western, museum, family and day-trip intent.", url: `${siteUrl}/explore/tours-experiences` },
