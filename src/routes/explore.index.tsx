...
export const Route = createFileRoute("/explore/")({
  head: ({ loaderData }: { loaderData?: { categories: Category[]; regions: Region[]; destinations: Destination[]; articles: Article[] } }) => {
    ...
    const items = [
      ...
      { "@type": "CollectionPage" as const, name: "Texas Wildlife Species", description: "Source-verified profiles for notable Texas mammals, birds and reptiles with habitat context and official TPWD guidance.", url: `${siteUrl}/explore/wildlife-species` },
