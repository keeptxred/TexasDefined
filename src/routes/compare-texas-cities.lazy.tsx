...
import { TexasCityComparisonTool } from '@/components/relocation/TexasCityComparisonTool';
...
export const Route = createLazyFileRoute('/compare-texas-cities')({ component: Page });
...
function Page() {
  return <Container className="pb-16 pt-12 sm:pb-24 sm:pt-16"><article className="mx-auto max-w-6xl">
    ...
    <section className="py-10"><TexasCityComparisonTool /></section>
