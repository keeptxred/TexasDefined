  ...
  head: ({ loaderData, params }) => {
    ...
    return {
      ...
      scripts: [jsonLd({
        ...
        "@graph": [
          { "@type": "DefinedTerm", "@id": `${pageUrl}#term`, name: symbol.name, description: symbol.shortDefinition, url: pageUrl, inDefinedTermSet: `${siteUrl}/explore/painted-churches/symbols#symbols`, sameAs: symbol.sourceUrl, subjectOf: symbol.churchSlugs.map((slug) => `${siteUrl}/explore/painted-churches/${slug}`) },
