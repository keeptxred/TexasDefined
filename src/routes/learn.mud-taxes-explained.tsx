...
const description = 'Texas municipal utility district (MUD) taxes explained: infrastructure debt, tax rates, utility fees, disclosures, homebuyer research and long-term cost planning.';
const siteUrl = `https://${texasDefinedBrand.identity.domain}`;
const pageUrl = `${siteUrl}${canonicalPath}`;
const faqs = [
  { question: 'What is a Texas municipal utility district (MUD)?', answer: 'A municipal utility district is a local governmental entity that can provide water, wastewater, drainage, roads and related infrastructure and may impose property taxes and service charges.' },
...
export const Route = createFileRoute('/learn/mud-taxes-explained')({
  head: () => ({ meta: buildMeta(texasDefinedBrand, { canonicalPath, title: 'Texas Municipal Utility District (MUD) Taxes Explained', description }), links: [canonicalLink(texasDefinedBrand, canonicalPath)], scripts: [jsonLd({ '@context': 'https://schema.org', '@graph': [
    { '@type': 'Article', headline: 'Texas Municipal Utility District (MUD) Taxes Explained', description, url: pageUrl, dateModified: '2026-08-06', publisher: { '@id': `${siteUrl}/#organization` } },
  ...
  component: () => <PropertyClusterGuidePage eyebrow="Special district costs" title="Texas Municipal Utility District (MUD) Taxes Explained" intro={description} officialUrl="https://www.tceq.texas.gov/permitting/water-districts" officialLabel="Texas Commission on Environmental Quality water district resources" faqs={faqs} sections={[
