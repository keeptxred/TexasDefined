...
const canonicalPath = "/texas-lighthouses";
...
export const Route = createFileRoute(canonicalPath)({
  head: () => {
    const base = buildEditorialCollectionHead(texasDefinedBrand, {
      ...
      breadcrumbParentName: "History",
      breadcrumbParentPath: "/texas-history",
    ...
    <section className="border-b border-border bg-surface">
      <Container className="py-16 sm:py-24">
        <nav aria-label="Breadcrumb" className="text-[0.72rem] uppercase tracking-[0.14em] text-muted-foreground">
          <ol className="flex flex-wrap gap-2"><li><Link to="/">Front page</Link></li><li aria-hidden>·</li><li><Link to="/texas-history">History</Link></li><li aria-hidden>·</li><li aria-current="page">Texas lighthouses</li></ol>
        </nav>
      ...
      <section className="grid gap-10 lg:grid-cols-[minmax(0,1.45fr)_minmax(300px,.55fr)]">
        ...
        <aside className="border-t-2 border-foreground pt-6 lg:mt-16">
          ...
          <div className="mt-6 flex flex-col items-start gap-3 text-sm">
            ...
            <Link to={selected.countyHref} className="border-b border-primary text-primary">Explore {selected.county.replace(" County", "")} County</Link>
          </div>
        </aside>
      </section>
