...
const LEGACY_PLAN_VISIT_HEADING = /(<h2[^>]*>)\s*Plan the visit\s*(<\/h2>)/i;
...
function normalizePlanningHeading(html: string) {
...
function MajorEventGuidePage() {
  ...
  const eventHtml = injectStayNearbySlot(normalizePlanningHeading(stabilizeEventHtml(page.slug, page.html)));
  return (
    <>
