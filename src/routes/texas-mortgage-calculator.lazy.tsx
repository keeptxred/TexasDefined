...
const faqs = [
  ...
  { question: 'Should I include HOA dues or special-district costs in the mortgage payment?', answer: 'Include them in the household budget even when they are not technically part of principal and interest. Homeowners association (HOA) dues, municipal utility district (MUD) taxes, public improvement district (PID) assessments and other recurring charges can change the amount of cash the property requires each month.' },
