...
const seoTitle = "Texas Homes & Real Estate: Buying, Building & Owning";
...
export const Route = createFileRoute("/real-estate")({
  ...
  }) : ({ meta: buildMeta(texasDefinedBrand, { canonicalPath: "/real-estate", title: seoTitle, description, image: heroHillCountry, imageAlt, imageWidth: 1600, imageHeight: 1067 }), links: [canonicalLink(texasDefinedBrand, "/real-estate")] }),
