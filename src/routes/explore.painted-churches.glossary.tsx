...
export const Route = createFileRoute(canonicalPath)({
  loader: async () => {
    ...
    return { terms: paintedChurchGlossary };
  },
  head: ({ loaderData }) => {
    ...
    return {
      ...
      scripts: [jsonLd({ "@context": "https://schema.org", "@graph": [
        ...
        { "@type": "DefinedTermSet", "@id": `${pageUrl}#terms`, name: "Texas Painted Church architecture terms", hasDefinedTerm: terms.map((term) => ({ "@type": "DefinedTerm", name: term.name, description: term.definition, url: `${pageUrl}/${term.slug}` })) },
      ] })],
    };
  },
