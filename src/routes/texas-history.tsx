...
const historicAuthorityGuides = [
  ...
  { slug: "texas-us-mexican-war-rio-grande-guide", eyebrow: "1846–1848", title: "Texas and the U.S.–Mexican War", description: "Use Palo Alto, Resaca de la Palma and Fort Brown to understand annexation, the disputed Rio Grande boundary and the war that followed statehood." },
  ...
  { slug: "texas-national-guard-camp-mabry-history", eyebrow: "1892 → present", title: "Camp Mabry & the Texas National Guard", description: "Trace the Texas Volunteer Guard, federal National Guard reforms, the 36th Division, world-war mobilization and the active Austin installation that preserves the institutional story." },
