...
export const Route = createFileRoute("/destination/$slug")({
  ...
  head: ({ loaderData, params }) => {
    ...
    const pageCitations = [...new Set([...authorityCitations, ...campingCitations])];
