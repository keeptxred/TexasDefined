    ...
    <Container className="py-12 sm:py-16">
      <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
        ...
        <div className="max-w-3xl space-y-5 text-base leading-8 text-muted-foreground">
          ...
          <p>Every paid relationship is disclosed. Advertising does not buy editorial coverage, rankings, reviews, recommendations or factual conclusions, and Texas Defined does not guarantee traffic, clicks, leads, bookings, sales or search rankings.</p>
