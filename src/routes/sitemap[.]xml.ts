  ...
  server: {
    handlers: {
      GET: async () => {
        ...
        const [articlesResult, collectionsResult, authorsResult, graphResult, remoteArticlesResult, countyHousingResult, fishingGuideSitemapResult, fishingReportSitemapResult] = coreResults;
