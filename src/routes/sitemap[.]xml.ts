  ...
  server: {
    handlers: {
      GET: async () => {
        ...
        const paths = [
          "/", "/explore", "/sports", "/events", "/texas-history", "/moving-to-texas", "/home-garden", "/real-estate", "/guides",
          "/learn/property-taxes", "/learn/property-tax-payments", "/learn/appraisal-districts", "/decide/property-taxes", "/do/homestead-exemption", "/do/property-tax-protest", "/browse/counties", "/browse/cities",
          "/shop", "/about",
