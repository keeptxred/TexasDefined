...
export const nextStops = [
  ['Plan a move to Texas', '/moving-to-texas', 'Use the relocation research center for metro guides, city matching, address-level official-source research, moving tasks and cost tools.'],
