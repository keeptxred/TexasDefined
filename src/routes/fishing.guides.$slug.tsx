...
export const Route = createFileRoute("/fishing/guides/$slug")({
  ...
  notFoundComponent: () => <div className="mx-auto max-w-3xl px-6 py-20"><h1 className="font-display text-4xl">Fishing guide not found</h1><p className="mt-4 text-muted-foreground">This guide may be unavailable, unpublished or still under review.</p><a href="/fishing/guides" className="mt-6 inline-block border-b border-primary pb-1 font-semibold text-primary">Browse fishing guides →</a></div>,
});
