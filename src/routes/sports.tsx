...
const description = "Texas sports guide to football, pro teams, stadiums, rodeo and game-day traditions across the state.";
const seoTitle = "Texas Sports: Football, Rodeo, Teams & Stadiums";
