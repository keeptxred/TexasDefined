...
export const Route = createFileRoute(canonicalPath)({
  head: () => {
    ...
    return {
      meta: buildMeta(texasDefinedBrand, { canonicalPath, title: "Texas Painted Churches Artwork & Interior Feature Inventory", description, modifiedTime: "2026-08-19T23:00:00-05:00" }),
      ...
      scripts: [jsonLd({
        ...
        "@graph": [
          ...
          { "@type": "ItemList", "@id": `${url}#features`, numberOfItems: canonicalPaintedChurchFeatures.length, itemListElement: canonicalPaintedChurchFeatures.map((feature, index) => ({ "@type": "ListItem", position: index + 1, name: feature.name, description: feature.description, url: absoluteUrl(texasDefinedBrand, `/explore/painted-churches/${feature.churchSlug}`) })) },
        ],
      })],
    };
  },
