...
const description = "The comprehensive Texas Painted Churches guide: 22 verified church profiles, Schulenburg route planning, statewide map, comparison table, National Register context, visitor guidance and rights-verified photography.";
...
export const Route = createFileRoute(canonicalPath)({
  head: () => ({
    meta: buildMeta(texasDefinedBrand, {
      canonicalPath,
      title: "Painted Churches of Texas | Map, Route & 22-Church Guide",
      description,
      modifiedTime: "2026-08-18T12:00:00-05:00",
    }),
      ...
      "@graph": [
        {
          ...
          subjectOf: [
            ...
            { "@type": "WebPage", url: absoluteUrl(texasDefinedBrand, "/explore/painted-churches/map"), name: "Texas Painted Churches map and directory" },
          ],
        },
        {
          "@type": "ItemList",
