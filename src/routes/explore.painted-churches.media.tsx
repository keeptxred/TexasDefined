...
const description = "A source-verified multimedia and oral-history research library for the Texas Painted Churches, centered on Austin PBS, parish histories, archival interview documentation and church-specific research resources.";
...
const resources = [
  ...
  {
    title: "St. Mary's Umbarger parish history",
    type: "Parish-controlled community history",
    url: "https://stmarysumbarger.com/history",
    note: "The active parish preserves a detailed account of the Italian POW artists, the 1945 painting campaign, local models and farm scenes, carved work, stained glass, community meals, later reunions and subsequent changes to the sanctuary.",
  },
  {
    title: "Restoring the Beauty of a Panhandle Treasure",
    type: "Diocesan preservation history",
    url: "https://amarillodiocese.org/news/restoring-the-beauty-of-a-panhandle-treasure",
    note: "The Diocese of Amarillo documents the POW artists by name, their artistic backgrounds and the restoration context for St. Mary's in Umbarger.",
  },
  {
    title: "Color Me Catholic: The Umbarger Mural Story",
    type: "Oral-history / historian interview",
    url: "https://music.amazon.in/podcasts/8a0552b4-9dfa-410a-9dd0-95ffacf49e90/episodes/7e1aa490-f147-4efc-bee0-eceb413a537a/the-west-texas-catholic-the-podcast-color-me-catholic-the-umbarger-mural-story",
    note: "A 2025 West Texas Catholic podcast episode interviews Umbarger native and art historian Michaela Wegman about the Italian POW mural project and its continuing community meaning.",
  },
] as const;
...
const documentedVoices = [
  ...
  ["Michaela Wegman", "Umbarger native and art historian interviewed by West Texas Catholic about the 1945 POW mural project"],
  ["Umbarger parish community", "the parish's own history preserves local memories about the artists, meals, schoolchildren, farm scenes used in the murals and later POW reunions"],
] as const;
