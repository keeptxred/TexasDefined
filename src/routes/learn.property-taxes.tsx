...
function Page() {
  return <PropertyTaxGuidePage eyebrow="Texas Home & Property" title="Texas Property Taxes: The Complete Guide" intro={description} officialUrl="https://comptroller.texas.gov/taxes/property-tax/" officialLabel="Texas Comptroller property-tax guidance" sections={[
