...
function PaintedChurchComparison() {
  ...
  return <main>
    <section className="border-b border-border bg-surface"><Container className="py-16 sm:py-24">
      ...
      <p className="mt-6 max-w-4xl text-lg leading-8 text-muted-foreground">The comparison brings the full research framework together: building and painting dates, architects and artists where documented, classification, interior integrity, cultural heritage, techniques, symbols and formal historic designation.</p>
