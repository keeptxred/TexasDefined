...
const faqs = [
  ...
  { question: 'How do I identify municipal utility district (MUD) and other special-district taxes?', answer: 'Review the appraisal account, tax bill, title documents, district notices and county truth-in-taxation records for the exact parcel.' },
];
...
export const Route = createFileRoute('/learn/homebuyer-property-tax-checklist')({
  ...
  component: () => <PropertyClusterGuidePage eyebrow="Before and after closing" title="Texas Homebuyer Property Tax Checklist" intro={description} officialUrl="https://comptroller.texas.gov/taxes/property-tax/basics.php" officialLabel="Texas Comptroller property-tax basics" faqs={faqs} sections={[
    ...
    { id: 'jurisdictions', title: 'Identify every taxing jurisdiction', paragraphs: ['Confirm the county, city, school district, municipal utility district (MUD), emergency services district (ESD), hospital district, community college and other special districts serving the parcel. Nearby homes can have different totals.'] },
