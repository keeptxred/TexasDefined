    ...
    <article className="mx-auto max-w-6xl">
      ...
      <section className="grid gap-8 border-b border-border py-10 lg:grid-cols-[15rem_1fr]">
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <Related href="/texas-high-school-football-championship-history" title="Explore championship history" body="Compare current UIL programs by all-time state-title and state-final totals and jump directly to each school profile." />
