    ...
    <article className="mx-auto max-w-6xl">
      ...
      <section className="grid gap-8 border-b border-border py-10 lg:grid-cols-[15rem_1fr]">
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <Related href="/texas-high-school-football-scores-schedules" title="Check scores and schedules" body="Use the 2026 season guide, then open the UIL Texas Scoreboard for the latest submitted weekly schedules and scores." />
