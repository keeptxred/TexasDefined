...
function ExploreCategoryPage() {
  ...
  return <>
    ...
    {showWildlifeGuide ? <Container className="pb-10 sm:pb-14"><section className="grid gap-6 border-y border-border py-7 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center"><div><p className="eyebrow text-primary">Texas wildlife by habitat</p><h2 className="mt-2 font-display text-3xl">Texas Wildlife Guide</h2><p className="mt-3 max-w-3xl text-sm leading-7 text-muted-foreground">Go from outdoor destinations to the animals and habitats behind them, including East Texas forests, Gulf wetlands, Hill Country rivers, prairie, brush country and the Trans-Pecos desert.</p><div className="mt-4 flex flex-wrap gap-x-6 gap-y-2 text-sm font-semibold"><Link to="/explore/wildlife" className="text-primary underline decoration-primary/40 underline-offset-4">Browse wildlife refuges &amp; destinations</Link><Link to="/article/texas-wildlife-guide" className="text-primary underline decoration-primary/40 underline-offset-4">Read the wildlife field guide</Link></div></div></section></Container> : null}
