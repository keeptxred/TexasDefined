...
function ExploreCategoryPage() {
  ...
  return <>
    ...
    {showWildlifeGuide ? <Container className="pb-10 sm:pb-14"><section className="grid gap-7 border-y border-border py-7 lg:grid-cols-2"><div><p className="eyebrow text-primary">Texas wildlife destinations</p><h2 className="mt-2 font-display text-3xl">Refuges, sanctuaries &amp; animal destinations</h2><p className="mt-3 max-w-3xl text-sm leading-7 text-muted-foreground">Move from the broad outdoors catalog into a wildlife-first index of national wildlife refuges, wildlife-rich parks, birding places and animal-focused destinations, with county links and official visitor sources.</p><Link to="/explore/wildlife" className="eyebrow mt-4 inline-block border-b border-primary pb-1 text-primary">Explore wildlife destinations →</Link></div><div><p className="eyebrow text-primary">Texas wildlife by habitat</p><h2 className="mt-2 font-display text-3xl">Texas Wildlife Guide</h2><p className="mt-3 max-w-3xl text-sm leading-7 text-muted-foreground">Go from outdoor destinations to the animals and habitats behind them, including East Texas forests, Gulf wetlands, Hill Country rivers, prairie, brush country and the Trans-Pecos desert.</p><Link to="/article/texas-wildlife-guide" className="eyebrow mt-4 inline-block border-b border-primary pb-1 text-primary">Explore Texas wildlife →</Link></div></section></Container> : null}
