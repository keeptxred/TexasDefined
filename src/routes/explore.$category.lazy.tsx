...
function ExploreCategoryPage() {
  ...
  const { destinations, authorityGuide } = Route.useLoaderData();
  ...
  return <>
    <CategoryPage category={match.slug as CategorySlug} eyebrow={match.eyebrow} title={match.name} intro={match.description} image={match.image} authorityGuide={authorityGuide} />
