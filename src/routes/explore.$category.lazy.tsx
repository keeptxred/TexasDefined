...
function ExploreCategoryPage() {
  ...
  return <>
    ...
    {showFoodHistory ? <Container className="pb-10 sm:pb-14"><section className="border-y border-border py-7"><div className="grid gap-6 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center"><div><p className="eyebrow text-primary">The stories behind the Texas table</p><h2 className="mt-2 font-display text-3xl">Texas Food History</h2><p className="mt-3 max-w-3xl text-sm leading-7 text-muted-foreground">Go beyond restaurant lists with the history behind barbecue, San Antonio chili, chicken-fried steak, breakfast tacos, German and Czech foodways and Dr Pepper's Waco origin.</p></div><Link to="/texas-food-history" className="eyebrow inline-block border-b border-primary pb-1 text-primary">Explore Texas food history →</Link></div><div className="mt-6 flex flex-wrap gap-x-5 gap-y-3 text-sm font-semibold"><a href="/food/kreuz-market-lockhart" className="underline decoration-primary/40 underline-offset-4">Kreuz Market</a><a href="/food/blacks-barbecue-lockhart" className="underline decoration-primary/40 underline-offset-4">Black's Barbecue</a><a href="/food/louie-mueller-barbecue-taylor" className="underline decoration-primary/40 underline-offset-4">Louie Mueller</a><a href="/food/czech-stop-west" className="underline decoration-primary/40 underline-offset-4">Czech Stop</a><a href="/food/gaidos-seafood-galveston" className="underline decoration-primary/40 underline-offset-4">Gaido's</a><a href="/food/perini-ranch-steakhouse-buffalo-gap" className="underline decoration-primary/40 underline-offset-4">Perini Ranch</a></div></section></Container> : null}
