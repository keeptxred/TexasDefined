...
function ExploreCategoryPage() {
  ...
  const { destinations, authorityHtml, foodDestinations } = Route.useLoaderData();
  ...
  return <>
    ...
    {showFoodHistory ? <FoodAuthorityCollection foodDestinations={foodDestinations} /> : null}
...
function FoodAuthorityCollection({ foodDestinations }: { foodDestinations: FoodDestinationCard[] }) {
