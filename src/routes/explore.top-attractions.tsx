    ...
    <Container className="pb-8 pt-12 sm:pt-16">
      ...
      <header className="py-10 sm:py-14">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <a href="/top-25-texas-attractions.json" className="inline-flex items-center border border-border px-5 py-3 text-sm font-semibold transition-colors hover:border-primary hover:text-primary">Download JSON data →</a>
    ...
    <Section>
      <Container>
        ...
        <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="border-t-2 border-foreground pt-4"><p className="eyebrow text-primary">Update history</p><p className="mt-2 text-sm leading-6 text-muted-foreground">Changing operational details are separated from durable editorial context and pointed back to official sources.</p></div>
        </div>
