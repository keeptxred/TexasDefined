...
const localPlanning = [
  { to: '/property-tax-calculator/bexar-county', label: 'Bexar County property-tax calculator', body: 'Start with Bexar County, then select the actual school, city and special districts serving the parcel.' },
  { to: '/property-tax-calculator/fort-bend-county', label: 'Fort Bend County property-tax calculator', body: 'Build a Fort Bend County estimate that keeps school districts, cities and MUD or other special-district rates visible.' },
  { to: '/property-tax-calculator/montgomery-county', label: 'Montgomery County property-tax calculator', body: 'Estimate a Montgomery County parcel with its actual local taxing-unit stack rather than a countywide average.' },
  { to: '/property-tax-calculator/williamson-county', label: 'Williamson County property-tax calculator', body: 'Compare a Williamson County address using the county, school, city and applicable special-district rates.' },
  { to: '/property-tax-calculator/hidalgo-county', label: 'Hidalgo County property-tax calculator', body: 'Build a Hidalgo County property-tax scenario from the local jurisdictions that apply to the address.' },
  { to: '/texas-mortgage-calculator/houston', label: 'Houston mortgage calculator', body: 'Model principal and interest alongside the local ownership costs that can change across the Houston area.' },
  { to: '/texas-home-affordability-calculator/houston', label: 'Houston home-affordability calculator', body: 'Pressure-test a Houston-area purchase price using income, debt, down payment and address-specific recurring costs.' },
  { to: '/texas-home-insurance-calculator/houston', label: 'Houston home-insurance calculator', body: 'Build an early insurance budget, then replace planning assumptions with a quote for the exact property and coverage.' },
] as const;
