...
const localPlanning = [
  { to: '/texas-property-tax-estimator#bexar-county', label: 'Bexar County property-tax calculator', body: 'Start with Bexar County, then select the actual school, city and special districts serving the parcel.' },
  { to: '/texas-property-tax-estimator#fort-bend-county', label: 'Fort Bend County property-tax calculator', body: 'Build a Fort Bend County estimate that keeps school districts, cities and MUD or other special-district rates visible.' },
  { to: '/texas-property-tax-estimator#montgomery-county', label: 'Montgomery County property-tax calculator', body: 'Estimate a Montgomery County parcel with its actual local taxing-unit stack rather than a countywide average.' },
  { to: '/texas-property-tax-estimator#williamson-county', label: 'Williamson County property-tax calculator', body: 'Compare a Williamson County address using the county, school, city and applicable special-district rates.' },
  { to: '/texas-property-tax-estimator#hidalgo-county', label: 'Hidalgo County property-tax calculator', body: 'Build a Hidalgo County property-tax scenario from the local jurisdictions that apply to the address.' },
