...
const texasExplainedPicks = [
  { title: "The Rivers That Built Texas", to: "/article/texas-rivers-explained" },
  { title: "Farm-to-Market Roads Explained", to: "/article/texas-farm-to-market-roads-explained" },
  { title: "The Cultural Regions of Texas", to: "/article/texas-cultural-regions-explained" },
] as const;
const sportsTravelPicks = [
  { eyebrow: "Statewide directory", title: "Texas Sports Venues", to: "/sports-venues" },
  { eyebrow: "North Texas", title: "Dallas–Fort Worth Sports Venues", to: "/sports-venues/dallas-fort-worth" },
  { eyebrow: "Texas football", title: "Football Stadiums", to: "/sports-venues/football" },
  { eyebrow: "Race weekends", title: "Texas Motorsports Venues", to: "/sports-venues/motorsports" },
] as const;
const popularTexasSearches = [
  { title: "Best places to go camping in Texas", to: "/best-places-to-go-camping-in-texas" },
  { title: "State Fair of Texas", to: "/texas-state-fair" },
  { title: "Texas vs every other state", to: "/texas-vs-every-state" },
  { title: "Texas fishing license", to: "/texas-fishing-license" },
  { title: "Texas driver license", to: "/texas-drivers-license" },
  { title: "Texas flag", to: "/texas-flag" },
  { title: "Texas Two Step", to: "/texas-two-step" },
  { title: "Texas resources", to: "/texas-resources" },
] as const;
