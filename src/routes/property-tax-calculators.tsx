...
const tools = [
  ['Property tax estimator', 'Choose the county, school district, city and applicable special districts, then estimate annual and monthly property tax from finalized Comptroller-reported rates.', '/texas-property-tax-estimator', 'I want to estimate taxes for a property'],
  ...
  ['Municipal utility / special-district impact', 'Search a municipal utility district (MUD) or other special district and estimate its annual, monthly and long-term tax impact.', '/texas-mud-tax-impact-calculator', 'I need to understand a utility-district tax'],
  ['Property-tax rate history', 'Search counties, cities, school districts, municipal utility districts and other taxing units and compare their finalized annual rates over time.', '/texas-property-tax-rate-history', 'I want to see how a tax rate changed'],
