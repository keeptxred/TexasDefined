...
function emergencyExploreSitemapResponse(error: unknown) {
  ...
  const fallbackPaths = [
    "/explore", "/explore/beaches-coast", "/explore/trip-planner", "/explore/attractions-comparison",
    "/explore/museums", "/explore/aquariums", "/explore/rv-parks", "/explore/wildlife", "/explore/water-towers",
    ...PAINTED_CHURCH_STATIC_PATHS,
    "/explore/top-attractions", "/explore/top-attractions/methodology", "/explore/top-attractions/road-trips",
    "/explore/route-66/texas-road-trip", "/explore/landscapes",
