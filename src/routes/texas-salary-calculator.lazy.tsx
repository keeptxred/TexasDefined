    ...
    <CalculatorPage eyebrow="Texas take-home pay calculator" title="Texas paycheck and take-home pay calculator" description={salaryDescription}>
      ...
      <section className="mt-14 border-t border-border pt-10" aria-labelledby="salary-estimate-heading">
        ...
        <div className="mt-5 max-w-3xl space-y-4 text-base leading-7 text-muted-foreground">
          ...
          <p>The calculator applies the 2026 federal income-tax brackets and standard deduction for the filing status you select, plus 2026 Social Security and Medicare rules. Verify actual withholding with payroll records and current federal guidance because Form W-4 elections, credits and employer payroll treatment can still change a paycheck.</p>
      ...
      <section className="mt-12 border-t border-border pt-10" aria-labelledby="salary-inputs-heading">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ['Federal income tax', 'The calculator applies the 2026 IRS tax-rate schedule and standard deduction for the filing status you select. Credits, itemized deductions and Form W-4 adjustments are not fully modeled.'],
      ...
      <section className="mt-12 border-t border-border pt-10" aria-labelledby="salary-sources-heading">
        ...
        <div className="mt-5 max-w-3xl space-y-4 text-base leading-7 text-muted-foreground">
          <p>TexasDefined does not prepare payroll or tax returns. The calculator uses published 2026 federal tax parameters for planning; compare the result with the official federal resources below and with your employer's paystub when you need withholding-level precision.</p>
