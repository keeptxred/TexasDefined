...
function ExploreSearchPage() {
  ...
  const data = useMemo(() => {
    ...
    return catalog
      ...
      .map((destination) => ({ destination, score: scoreDestination(destination, q), miles: originDestination ? distanceMiles(originDestination, destination) : null }))
  ...
  }, [catalog, q, category, region, season, accessible, originDestination, radiusFilterActive, radiusMiles]);
  ...
  return <>
    <section className="border-b border-border bg-surface">
      <Container className="py-16 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">Search by destination, town, county, landscape, activity or the kind of day you want to plan. Narrow by region, type, season, accessibility information or straight-line distance from an exact TexasDefined destination.</p>
