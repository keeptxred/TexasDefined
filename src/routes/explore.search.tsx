...
const searchSchema = z.object({ q: text, category: text, region: text, season: text, accessible: text });
...
function ExploreSearchPage() {
  ...
  }, [catalog, q, category, region, season, accessible]);
  ...
  return <>
    <section className="border-b border-border bg-surface">
      <Container className="py-16 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">Search by destination, town, county, landscape, activity or the kind of day you want to plan. Narrow by region, type, season or accessibility information.</p>
