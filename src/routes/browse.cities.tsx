...
export const Route=createFileRoute('/browse/cities')({head:()=>({meta: buildMeta(texasDefinedBrand, {
      canonicalPath: '/browse/cities',
      title:'Texas City Directory',description}),
    links: [canonicalLink(texasDefinedBrand, '/browse/cities')]}),component:()=> <TexasPlaceDirectory mode="cities" />});
