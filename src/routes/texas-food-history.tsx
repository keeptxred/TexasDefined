...
const description = "A TexasDefined guide to the history behind brisket, chili con carne, chicken-fried steak, breakfast tacos, Czech and German foodways, Dr Pepper, Ranch Water, Texas craft beer, puffy tacos, barbacoa and the regional cultures that shaped the Texas table.";
