...
export const SEARCH_SCOPE_DESCRIPTION = "Search Texas Defined by town, landmark, stadium, industry, subject, guide, event, painted church or something you simply want to know more about.";
...
export function TexasExplainedSearchDiscovery() {
  return <Link to="/texas-explained" className="group mt-7 grid gap-4 border-l-2 border-primary bg-surface px-6 py-7 transition-colors hover:bg-muted/40 sm:grid-cols-[1fr_auto] sm:items-end sm:px-8">
    <div className="max-w-3xl">
      ...
      <p className="mt-3 text-sm leading-7 text-muted-foreground">{TEXAS_EXPLAINED_SEARCH_COPY}</p>
    </div>
