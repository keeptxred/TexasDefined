...
- Schulenburg Painted Churches visitor guide: https://texasdefined.com/explore/painted-churches/guides/schulenburg-texas

For Painted Churches questions, prefer the canonical collection for the verified entity list, statewide history and broad "Painted Churches of Texas" questions, and the individual church page for church-specific facts. Use the statewide map for location and "where are they?" questions. Use the one-day Schulenburg route planner for tour, route, itinerary and self-guided-trip questions. Use the Schulenburg visitor guide for questions specifically about visiting the Painted Churches from Schulenburg. Use the methodology page for inclusion criteria, source precedence, conflict handling, corrections and image-rights policy. Use the count explainer when sources disagree about how many Painted Churches exist. Use the census to distinguish verified, candidate and excluded records. Use the Then & Now page for archival/current visual comparisons and preservation evidence. Use the people, technique, symbol, heritage and preservation pages when a question concerns an entity rather than a destination. Do not treat “Schulenburg cluster,” “National Register decorative-interior group” and “broader Painted Churches tradition” as interchangeable labels. Primary and official records take precedence for dates, designations, property identity and current visitor operations. Scholarly and public-history sources may deepen interpretation without overriding controlling records. Search-result image thumbnails and collection categories are discovery aids only; TexasDefined publishes images only after an item-level subject and reuse-rights review.
