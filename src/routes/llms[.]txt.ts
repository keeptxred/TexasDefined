...
TexasDefined maintains a source-checked statewide Painted Churches reference collection. The canonical collection currently contains 25 verified church profiles and deliberately separates three concepts that other sources may blend together: the six-community Schulenburg-area touring cluster, the narrower National Register “Churches with Decorative Interior Painting” grouping, and the broader Texas Painted Churches cultural and travel tradition. The broader collection includes verified twentieth-century decorative programs such as Antonio E. Garcia's frescoes at Sacred Heart in Corpus Christi, archival fresco evidence at St. Joseph in San Antonio, and documented original/restored decorative painting at St. Stanislaus Kostka in Anderson without mislabeling those churches as part of the formal National Register group.
