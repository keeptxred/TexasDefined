      ...
      <section className="border-y border-border bg-surface py-16 sm:py-20">
        <Container>
          ...
          <div className="mt-10 grid gap-px overflow-hidden border border-border bg-border md:grid-cols-2 xl:grid-cols-3">
            ...
            <PillarLink to="/texas-craft-beer-guide" eyebrow="Texas drinks" title="Texas Craft Beer Guide" text="Plan brewery travel by region with the current Guild network, brewery-law history, source-verified brewery destinations and annual beer festivals." />
            ...
            <PillarLink to="/article/unusual-texas-businesses-services" eyebrow="Specialized local businesses" title="Unusual Texas Businesses & Services" text="Pet freeze-dry preservation, a working blacksmith shop, beach horseback rides, giant homecoming mums and other businesses that are too distinctive for a generic directory listing." />
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_.95fr]">
            ...
            <aside className="border border-border bg-background p-7">
              ...
              <div className="mt-6 divide-y divide-border border-y border-border">
                ...
                <a href="/things-that-define-texas.csv" className="group block py-5"><span className="font-semibold group-hover:text-primary">Download the 250-item CSV →</span><span className="mt-1 block text-sm leading-6 text-muted-foreground">Item numbers, chapter membership, descriptions and links to deeper guides for analysis or reuse.</span></a>
                <a href="/things-that-define-texas.json" className="group block py-5"><span className="font-semibold group-hover:text-primary">Download JSON data →</span><span className="mt-1 block text-sm leading-6 text-muted-foreground">The same 250 reference rows with field definitions and methodology metadata for machine use.</span></a>
                ...
                <RelatedLink to="/article/unusual-texas-businesses-services" title="Unusual Texas businesses & services" text="Explore the specialized local businesses and experiences TexasDefined is testing as a new discovery layer." />
