...
export const Route=createFileRoute('/browse/counties')({head:()=>({meta: buildMeta(texasDefinedBrand, {
      canonicalPath: '/browse/counties',
      title:'Texas County Directory',description}),
    links: [canonicalLink(texasDefinedBrand, '/browse/counties')]}),component:()=> <TexasPlaceDirectory mode="counties" />});
