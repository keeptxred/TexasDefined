...
function TexasVsStatePage() {
  ...
  const sections = [
    ...
    },
    {
      ...
      body: `Texas ranges from humid Gulf Coast and Piney Woods to Hill Country, plains, desert and mountains. Compare the part of Texas you are considering with the actual part of ${name} you would live in, including heat, cold, severe weather, water access and outdoor recreation.`,
    },
    {
      heading: "Transportation and daily life",
      body: `Driving distances, transit, airport access and commute patterns can materially change daily costs. Texas is large, so Dallas-Fort Worth, Houston, Austin, San Antonio, El Paso and rural Texas can produce very different living experiences.`,
    },
    {
  ...
  return <main>
    <section className="border-b border-border bg-muted/30 py-14 md:py-20">
      <Container>
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-muted-foreground">A practical side-by-side framework for comparing Texas with {name}, focused on the factors that most often change a real household decision.</p>
      </Container>
    </section>
