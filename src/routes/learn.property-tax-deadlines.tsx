...
const calendarUrl = 'https://comptroller.texas.gov/taxes/property-tax/calendars/';
const faqs = [
...
export const Route = createFileRoute('/learn/property-tax-deadlines')({
  head: () => ({ meta: buildMeta(texasDefinedBrand, { canonicalPath, title: 'Texas Property Tax Deadlines', description }), links: [canonicalLink(texasDefinedBrand, canonicalPath)], scripts: [jsonLd({ '@context': 'https://schema.org', '@graph': [
    { '@type': 'Article', headline: 'Texas Property Tax Deadlines', description, url: pageUrl, dateModified: '2026-08-06', publisher: { '@id': `${siteUrl}/#organization` }, isBasedOn: calendarUrl },
  ...
  component: PropertyTaxDeadlinesPage,
});

function PropertyTaxDeadlinesPage() {
  return <>
    <PropertyClusterGuidePage eyebrow="Annual property-tax calendar" title="Texas Property Tax Deadlines" intro={description} officialUrl={calendarUrl} officialLabel="Texas Comptroller property-tax calendars" faqs={faqs} sections={[
      ...
      { id: 'protests', title: 'Protest deadlines', paragraphs: ['For many appraisal notices, the ordinary deadline is May 15 or 30 days after delivery, whichever is later. Other actions and notices can carry different deadlines.'], bullets: ['/do/property-tax-protest'] },
      { id: 'hearings', title: 'Appraisal review board (ARB) hearings and appeals', paragraphs: ['After a timely protest, the appraisal review board schedules a hearing. Arbitration, State Office of Administrative Hearings (SOAH) review and district-court appeals have separate filing and payment deadlines measured from receipt of the appraisal review board (ARB) order.'] },
    ...
    <Container className="pb-16 sm:pb-24"><CitationTrustPanel
      sources={[{ name: 'Texas Comptroller property-tax calendars', url: calendarUrl }, { name: 'Texas Comptroller property-tax protest guidance', url: 'https://comptroller.texas.gov/taxes/property-tax/protests/' }]}
      methodology="Texas Defined organizes recurring statewide property-tax milestones into a planning calendar. The guide deliberately distinguishes ordinary deadlines from parcel-specific or notice-specific deadlines; the official notice and current Comptroller guidance control when they differ."
      lastVerified="August 6, 2026"
      title="Deadline sources and methodology"
    /></Container>
  </>;
}
