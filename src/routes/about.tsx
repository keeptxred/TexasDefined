...
export const ABOUT_DESCRIPTION = "Texas Defined is a lifestyle magazine about the places, food, history, homes, traditions and people that make this state feel like nowhere else.";

export const Route = createFileRoute("/about")({
  head: () => ({
    meta: buildMeta(texasDefinedBrand, { canonicalPath: "/about", title: "About Texas Defined", description: ABOUT_DESCRIPTION }),
    links: [canonicalLink(texasDefinedBrand, "/about")],
    scripts: [jsonLd({ "@context": "https://schema.org", "@graph": [
      { "@type": "AboutPage", "@id": `${absoluteUrl(texasDefinedBrand, "/about")}#page`, url: absoluteUrl(texasDefinedBrand, "/about"), name: "About Texas Defined", description: ABOUT_DESCRIPTION, isPartOf: { "@id": `${absoluteUrl(texasDefinedBrand, "/")}#website` }, about: { "@id": `${absoluteUrl(texasDefinedBrand, "/")}#organization` } },
