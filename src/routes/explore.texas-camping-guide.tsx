...
const path = "/explore/texas-camping-guide";
...
export const Route = createFileRoute("/explore/texas-camping-guide")({
  head: () => ({
    ...
    scripts: [jsonLd({
      ...
      "@graph": [
        { "@type": "Article", "@id": `${pageUrl}#article`, headline: title, description, mainEntityOfPage: pageUrl, about: ["Texas camping", "Texas state parks", "campgrounds in Texas"] },
