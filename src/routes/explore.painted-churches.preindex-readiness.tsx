...
export const Route = createFileRoute(canonicalPath)({
  head: () => {
    ...
    return {
      meta: buildMeta(texasDefinedBrand, { canonicalPath, title: "Painted Churches Pre-Index Authority Audit", description, modifiedTime: `${checkedAt}T08:30:00-05:00` }),
...
function PreIndexReadiness() {
  return <main>
    <section className="border-b border-border bg-surface"><Container className="py-16 sm:py-24">
      ...
      <p className="mt-4 text-sm text-muted-foreground">Authority audit refreshed August 22, 2026.</p>
