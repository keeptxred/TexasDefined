...
function Page() {
  ...
  return <Container className="pb-16 pt-12 sm:pb-24 sm:pt-16"><article className="mx-auto max-w-6xl">
    ...
    <section className="pt-8 text-sm leading-6 text-muted-foreground"><p><strong className="text-foreground">Source:</strong> Texas Comptroller of Public Accounts, Property Tax Assistance Division, Tax Rates and Levies. Rates are dollars per $100 of taxable value. TexasDefined retains annual statewide files for historical comparison and withholds source-conflict or not-reported rates from calculators.</p><a href={latest.sourceUrl} target="_blank" rel="noreferrer noopener" className="mt-3 inline-block font-semibold text-primary underline decoration-primary/40 underline-offset-4">Open the official source workbook ↗</a></section>
  </article></Container>;
}
