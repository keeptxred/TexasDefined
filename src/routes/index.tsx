...
const sportsTravelPicks = [
  {
    eyebrow: "Statewide directory",
    title: "Texas Sports Venues",
    description: "Browse verified stadium, arena, ballpark, racetrack, college and tournament venue guides from across Texas.",
    to: "/sports-venues",
  },
  {
    eyebrow: "North Texas",
    title: "Dallas–Fort Worth Sports Venues",
    description: "Plan around major-league stadiums, racing, college sports, golf and other sports destinations across DFW.",
    to: "/sports-venues/dallas-fort-worth",
  },
  {
    eyebrow: "Texas football",
    title: "Football Stadiums",
    description: "Find professional, college and high-school football venues, then open the individual guide for visitor planning.",
    to: "/sports-venues/football",
  },
  {
    eyebrow: "Race weekends",
    title: "Texas Motorsports Venues",
    description: "Explore major speedways, circuits and motorsports destinations with event-day planning context and official links.",
