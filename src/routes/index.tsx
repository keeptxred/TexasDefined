...
export const Route = createFileRoute("/")({
  ...
  head: ({ loaderData }) => {
    ...
    const structuredData = { "@context": "https://schema.org", "@graph": [
      { "@type": "WebPage", "@id": `${siteUrl}/#homepage`, url: `${siteUrl}/`, name: "The Places, Stories & Life of Texas", description, isPartOf: { "@id": `${siteUrl}/#website` }, about: { "@id": `${siteUrl}/#organization` }, mainEntity: { "@id": `${siteUrl}/#editorial-picks` }, hasPart: [{ "@id": `${siteUrl}/#editorial-picks` }, { "@id": `${siteUrl}/#faq` }] },
