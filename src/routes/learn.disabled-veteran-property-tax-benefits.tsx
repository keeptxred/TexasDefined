...
const description = 'Texas disabled veteran property-tax exemption guide covering disability-rating tiers, 100% homestead exemptions, surviving spouses, donated homes, filing and local appraisal-district steps.';
...
export const Route = createFileRoute('/learn/disabled-veteran-property-tax-benefits')({
  head: () => ({ meta: buildMeta(texasDefinedBrand, { canonicalPath, title: 'Texas Disabled Veteran Property Tax Exemption & Benefits', description }), links: [canonicalLink(texasDefinedBrand, canonicalPath)], scripts: [jsonLd({ '@context': 'https://schema.org', '@graph': [
    { '@type': 'Article', headline: 'Texas Disabled Veteran Property Tax Exemption & Benefits', description, url: pageUrl, dateModified: '2026-08-11', publisher: { '@id': `${siteUrl}/#organization` } },
