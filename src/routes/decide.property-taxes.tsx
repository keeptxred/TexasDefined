...
function Page() {
  ...
  return <Container className="py-16 sm:py-24"><article className="mx-auto max-w-4xl"><p className="eyebrow text-primary">Know before you buy</p><h1 className="mt-3 font-display text-4xl sm:text-6xl">Estimate Your Property Taxes</h1><p className="mt-5 text-lg leading-8 text-muted-foreground">{description}</p>
    ...
    <div className="mt-8 rounded-lg border border-border p-5 text-sm leading-6 text-muted-foreground"><strong className="text-foreground">Use this as a planning number.</strong> The official bill calculates each taxing unit separately. Check the exact property, exemptions, adopted rates, MUDs and other special districts before making a decision.</div>
