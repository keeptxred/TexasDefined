...
['Down payment calculator','/texas-down-payment-calculator','Estimate down payment, closing costs, reserves and cash needed.'],
['Closing cost calculator','/texas-closing-cost-calculator','Estimate illustrative buyer and seller transaction costs.'],
['Down payment assistance calculator','/texas-down-payment-assistance-calculator','Model illustrative assistance and the remaining buyer cash gap.'],
['Rent vs buy calculator','/texas-rent-vs-buy-calculator','Compare simplified long-term renting and owning costs.'],
['Homeownership cost calculator','/texas-homeownership-cost-calculator','Combine mortgage, taxes, insurance, utilities, maintenance and fees.'],
['Home equity calculator','/texas-home-equity-calculator','Estimate current equity, loan-to-value and borrowing room.'],
['Home equity growth calculator','/texas-home-equity-growth-calculator','Project value, loan balance and equity over time.'],
['Mortgage payoff calculator','/texas-mortgage-payoff-calculator','Estimate payoff timing and interest with extra principal.'],
['Refinance savings calculator','/texas-refinance-savings-calculator','Compare payments, savings and break-even timing.'],
['Cost of living calculator','/texas-cost-of-living-calculator','Translate household spending with adjustable local indexes.'],
['Texas salary calculator','/texas-salary-calculator','Estimate take-home pay after adjustable deductions.'],
['Salary comparison by city','/texas-salary-comparison-by-city','Estimate a cost-adjusted salary for a Texas city.'],
['Texas budget planner','/texas-budget-planner','Build a household budget and savings target.'],
...
['Home insurance calculator','/texas-home-insurance-calculator','Model an illustrative premium from replacement cost and additions.'],
