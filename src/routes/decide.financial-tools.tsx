...
const sections = [
  ...
  ['Understand utility districts, improvement districts and HOA costs', '/article/muds-pids-hoas-special-districts-texas', 'See how municipal utility district taxes, public improvement district assessments and homeowners association dues can change the true carrying cost of a Texas home.', 'Property taxes'],
