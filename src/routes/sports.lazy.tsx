        ...
        <section className="mt-10 border-t border-border pt-10">
          <div className="grid gap-8 lg:grid-cols-[15rem_1fr]">
            ...
            <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
              ...
              <a href="/sports-venue/xtreme-raceway-park" className="group border-t border-border py-5"><strong className="block font-display text-2xl group-hover:text-primary">Xtreme Raceway Park, Ferris</strong><span className="mt-2 block text-sm leading-6 text-muted-foreground">An active eighth-mile NHRA drag strip on the I-45 corridor south of Dallas.</span><span className="mt-3 block text-sm font-semibold text-primary">Open Xtreme Raceway Park guide →</span></a>
