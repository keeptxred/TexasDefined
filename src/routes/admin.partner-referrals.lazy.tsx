  ...
  return <Container className="py-12 sm:py-16"><main className="mx-auto max-w-7xl">
    ...
    {!dashboard ? <form onSubmit={unlock} className="mt-10 max-w-lg grid gap-4">
      ...
      <section className="mt-12 border-t border-border pt-6">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">Measurement begins on {travelRoutingStartLabel} UTC, after the intent-based routing policy went live. Current active CJ terms put Orbitz and Travelocity at parity for conventional lodging: 4% with a 7-day referral period. Hold the current split until each provider has at least {dashboard.travelRoutingMinimumImpressionsPerPartner.toLocaleString()} qualifying CTA impressions, then compare CTR with downstream completed bookings, reversals and realized commission before changing routing.</p>
