  ...
  return <main>
    ...
    <Container className="grid gap-14 py-14 sm:py-18 lg:grid-cols-[minmax(0,1.45fr)_minmax(280px,.65fr)]">
      ...
      <aside className="space-y-10 lg:border-l lg:border-border lg:pl-8">
        <section><p className="eyebrow text-muted-foreground">Question this page answers</p><p className="mt-3 font-display text-2xl">{guide.searchIntent}</p><p className="mt-3 text-sm leading-6 text-muted-foreground">This page answers the question directly and links to the most relevant church or research page when you want more detail.</p></section>
