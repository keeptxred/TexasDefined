...
const faqs = [
  {
    question: 'What are closing costs in a Texas home purchase?',
    answer: 'Closing costs are the transaction expenses that sit outside the purchase price itself. Depending on the side of the transaction and the deal structure, they can include lender charges, title and settlement costs, prepaid items, recording charges, inspections, surveys, taxes, insurance-related amounts and negotiated credits.',
  },
  {
    question: 'Are buyer and seller closing costs the same?',
    answer: 'No. Buyers and sellers can face different categories of costs, and the final allocation depends on the contract, financing, title work and negotiated credits. This calculator separates buyer and seller planning rather than treating closing costs as one universal percentage.',
  },
  {
    question: 'Do closing costs include the down payment?',
    answer: 'The down payment and closing costs are separate planning items. A buyer may need cash for both, along with any reserves or prepaid amounts required for the transaction.',
  },
  {
    question: 'Can seller credits reduce the buyer cash needed at closing?',
    answer: 'A negotiated seller credit can reduce eligible buyer closing costs, subject to the contract and any lender or program limits. Enter credits separately so the estimate shows how they affect the cash-to-close scenario.',
  },
];
...
function TexasClosingCostCalculatorPage() {
  return (
    <CalculatorPage
      eyebrow="Texas closing-cost estimator"
    ...
    >
      ...
      <section className="mt-12 border-t border-border pt-10" aria-labelledby="closing-costs-plan-heading">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Link to="/texas-down-payment-calculator" className="border border-border p-5 hover:border-primary">
            ...
            <span className="mt-2 block text-sm leading-6 text-muted-foreground">Add the down payment, expected closing costs and a cash reserve to estimate total cash needed.</span>
          </Link>
          <Link to="/texas-mortgage-calculator" className="border border-border p-5 hover:border-primary">
            ...
            <span className="mt-2 block text-sm leading-6 text-muted-foreground">Estimate the recurring monthly housing payment after the one-time closing transaction.</span>
          </Link>
          <Link to="/texas-home-affordability-calculator" className="border border-border p-5 hover:border-primary">
            <strong className="font-display text-xl">Home affordability calculator</strong>
            <span className="mt-2 block text-sm leading-6 text-muted-foreground">Test how income, debts, down payment, taxes and insurance affect a possible home-price range.</span>
          </Link>
        </div>
      </section>
      ...
      <section className="mt-12 border-t border-border pt-10" aria-labelledby="closing-costs-faq-heading">
        ...
        <h2 id="closing-costs-faq-heading" className="mt-3 font-display text-3xl">Texas closing-cost calculator FAQ</h2>
