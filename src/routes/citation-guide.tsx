...
const GROUPS = [
  ...
  },
  {
    ...
    links: [
      ...
      ['Lake Fork fishing', '/fishing/lakes/lake-fork'],
      ['Sam Rayburn Reservoir fishing', '/fishing/lakes/sam-rayburn-reservoir'],
      ['Lake Livingston fishing', '/fishing/lakes/lake-livingston'],
      ['Lake Texoma fishing', '/fishing/lakes/lake-texoma'],
      ['Toledo Bend Reservoir fishing', '/fishing/lakes/toledo-bend-reservoir'],
      ['Possum Kingdom Reservoir fishing', '/fishing/lakes/possum-kingdom-reservoir'],
      ['Canyon Lake fishing', '/fishing/lakes/canyon-lake'],
      ['Choke Canyon Reservoir fishing', '/fishing/lakes/choke-canyon-reservoir'],
      ['Amistad Reservoir fishing', '/fishing/lakes/amistad-reservoir'],
      ['O.H. Ivie Lake fishing', '/fishing/lakes/o-h-ivie-lake'],
      ['Lake Travis fishing', '/fishing/lakes/lake-travis'],
      ['Lake Whitney fishing', '/fishing/lakes/lake-whitney'],
      ['Lake Tawakoni fishing', '/fishing/lakes/lake-tawakoni'],
      ['Falcon International Reservoir fishing', '/fishing/lakes/falcon-international-reservoir'],
    ],
  },
  {
    title: 'Painted Churches of Texas',
    description: 'A 28-church verified heritage collection with dedicated pages for decorative techniques, symbols, people, cultural communities, preservation, archives, routes and research methodology.',
    links: [
