    ...
    <section className="py-12 md:py-16">
      <Container>
        <div className="grid gap-6 border-b border-border pb-10 md:grid-cols-3">
          ...
          <div><p className="eyebrow text-primary">Public-first inventory</p><h2 className="mt-2 font-display text-3xl">Public lands and park systems first</h2><p className="mt-3 text-sm leading-7 text-muted-foreground">The database prioritizes TPWD, National Park Service, U.S. Army Corps of Engineers, U.S. Forest Service and Lower Colorado River Authority camping rather than scraping private campground directories.</p></div>
