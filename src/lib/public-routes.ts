export const INDEXABLE_STATIC_PATHS = [
  ...
  "/texas-industries/advanced-manufacturing",
  "/texas-industries/trade-transportation-logistics",
  "/texas-industries/aerospace-aviation-defense",
  "/texas-industries/healthcare-life-sciences",
  "/texas-industries/agriculture-livestock",
  "/texas-industries/financial-services",
  "/texas-industries/construction-real-estate",
  "/texas-industries/corporate-professional-services",
  "/texas-industries/hospitality-tourism-culture",
  "/texas-college-towns",
