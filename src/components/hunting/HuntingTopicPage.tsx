  ...
  return (
    <section className="border-y border-border bg-surface py-14 sm:py-18" aria-labelledby="hunting-public-land-heading">
      <div className="mx-auto w-full max-w-6xl px-5 sm:px-8">
        ...
        <p className="mt-4 max-w-3xl text-base leading-7 text-muted-foreground">Use TexasDefined&apos;s existing statewide search to find Wildlife Management Area place guides by name, county or nearby town, then confirm current access and hunt rules with the official TPWD source on the destination guide.</p>
