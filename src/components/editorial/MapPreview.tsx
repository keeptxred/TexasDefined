  ...
  return (
    <div className={className}>
      <div className="border-t-2 border-foreground pt-5">
        ...
        {showImage && image ? <img src={image} alt={`Map showing ${directionsLabel}`} width={800} height={400} loading="lazy" className="mt-4 w-full" onError={() => setFailedImage(image)} /> : <p className="mt-3 font-display text-2xl">Find it on the map</p>}
