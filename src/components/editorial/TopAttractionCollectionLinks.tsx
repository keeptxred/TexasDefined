  ...
  return <Section tone="surface">
    <Container>
      <SectionHeader
        ...
        description="These places are part of TexasDefined's statewide Top 25 reference collection. Each guide includes official source links, update history, trip-planning assessments, three itinerary options and a full nearby-area guide."
      />
