...
export type TexasExplainedLoaderData = {
  articles: Article[];
  pillars: Article[];
  supportArticles: Article[];
  depthArticles: Article[];
  riverProfiles: Article[];
  reservoirProfiles: Article[];
  roadSystems: Article[];
};

export function buildTexasExplainedLoaderData(catalog: Article[]): TexasExplainedLoaderData {
  return {
...
const supportingExplainers = [
  ...
  { to: "/explore/landscapes/where-does-texas-turn-into-desert", title: "Texas landforms: where Texas turns into desert", description: "Trace the transition from plains and Hill Country toward the Chihuahuan Desert through rainfall, elevation, mountains, basins and arid West Texas geography." },
