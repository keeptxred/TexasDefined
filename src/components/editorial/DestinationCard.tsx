...
function DestinationImage({ destination, eager, overlay }: { destination: Destination; eager: boolean; overlay: boolean }) {
  ...
  if (isDestinationPhotoPlaceholder(hero.src)) {
    return <div aria-hidden="true" className={cn(imageClass, "relative overflow-hidden bg-[linear-gradient(145deg,hsl(var(--muted)),hsl(var(--secondary))_52%,hsl(var(--primary)/0.18))]")}>
