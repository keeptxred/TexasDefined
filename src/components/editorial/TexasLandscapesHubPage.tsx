...
import type { LandscapeCatalogItem, LandscapeGuideCatalogItem } from '@/data/texas-landscape-catalog';

type TexasLandscapesHubPageProps = {
  description: string;
  landscapes: LandscapeCatalogItem[];
  guides: LandscapeGuideCatalogItem[];
};

export function TexasLandscapesHubPage({ description, landscapes, guides }: TexasLandscapesHubPageProps) {
  return <>
