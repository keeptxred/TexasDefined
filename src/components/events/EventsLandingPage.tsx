...
export function EventsLandingPage({ data, search, breadcrumb }: { data: EventsLandingData; search: EventSearch; breadcrumb: ReactNode }) {
  ...
  return <>
    ...
    <Container><TexasEventCarousel events={upcomingEventRecords} title="Upcoming events across Texas" eyebrow="Statewide calendar" viewAllHref="/events#calendar" /></Container>
    ...
    <DiscoverySection eyebrow="Plan by time" title="What’s happening when" description="Finite rolling and seasonal views use the same current event catalog." links={eventTimingLinks} />
