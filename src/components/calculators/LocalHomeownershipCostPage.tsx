...
export function LocalHomeownershipCostPage({ profile }: { profile: LocalHomeownershipCostProfile }) {
  ...
  const links: LocalHousingPlannerLink[] = [
    { href: mortgagePath, title: `${profile.name} mortgage calculator`, copy: 'Build principal, interest, parcel-specific property tax and insurance as the financing core of the monthly ownership budget.' },
