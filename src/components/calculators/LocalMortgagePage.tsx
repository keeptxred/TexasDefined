...
export function LocalMortgagePage({ profile }: { profile: LocalMortgageProfile }) {
  ...
  return <LocalHousingPlannerPage
    ...
    partner={{ partnershipType: 'mortgage', sourcePath: `/texas-mortgage-calculator/${profile.slug}`, title: `Provide mortgage or home-buying services in ${profile.name}?`, copy: 'Texas Defined can review clearly disclosed mortgage and home-buying partnerships on relevant planning surfaces. Commercial participation never changes payment math, lender-neutral guidance or editorial conclusions.' }}
