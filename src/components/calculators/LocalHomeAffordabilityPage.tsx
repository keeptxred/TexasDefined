...
export function LocalHomeAffordabilityPage({ profile }: { profile: LocalHomeAffordabilityProfile }) {
  ...
  const links: LocalHousingPlannerLink[] = [
    ...
    { href: mortgagePath, title: `${profile.name} mortgage calculator`, copy: 'Turn the local home-price scenario into principal, interest, parcel-specific property tax and insurance in one monthly payment view.', action: 'Estimate mortgage payment →' },
