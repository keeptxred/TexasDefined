...
export function PropertyTaxGuidePage({ eyebrow, title, intro, sections, officialUrl, officialLabel }: Props) {
  ...
  return <Container className="py-16 sm:py-24"><article className="mx-auto max-w-4xl">
    ...
    <p className="mt-4 text-sm text-muted-foreground">Last checked August 3, 2026. Use this as a starting point, then confirm the current rules with the responsible office.</p>
