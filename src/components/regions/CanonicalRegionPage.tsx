...
import type { CanonicalPrimaryRegionDefinition, TexasMetroDefinition, TexasSubregionDefinition } from "@/data/canonical-geography";
import type { CanonicalRegionPresentation } from "@/data/canonical-region-presentation";
import type { TexasPlaceGeography } from "@/data/geography-knowledge-graph";
import type { Destination } from "@/data/types";

export interface CanonicalRegionPageProps {
  region: CanonicalPrimaryRegionDefinition;
  presentation: CanonicalRegionPresentation;
  subregions: readonly TexasSubregionDefinition[];
  metros: readonly TexasMetroDefinition[];
  places: readonly TexasPlaceGeography[];
  countySlugs: readonly string[];
  destinations: readonly Destination[];
  adjacent: readonly CanonicalPrimaryRegionDefinition[];
  allRegions: readonly CanonicalPrimaryRegionDefinition[];
}

export function CanonicalRegionPage({ region, presentation, subregions, metros, places, countySlugs, destinations, adjacent, allRegions }: CanonicalRegionPageProps) {
