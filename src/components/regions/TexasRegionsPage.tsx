...
import type { CanonicalPrimaryRegionDefinition } from "@/data/canonical-geography";
...
export interface TexasRegionsPageProps {
  regionCards: readonly RegionCard[];
}

export function TexasRegionsPage({ regionCards }: TexasRegionsPageProps) {
  return <>
