  ...
  const mapFigure = (
    <figure>
      {imageAvailable ? <div className="overflow-hidden border border-border bg-muted/30">
        ...
        />
      </div> : <div className="flex items-center justify-center border border-border bg-muted/30 px-6 text-center text-sm text-muted-foreground" style={{ minHeight: "12rem" }} role="img" aria-label={`${contextName} parking map unavailable`}>Parking map image unavailable. Use the official parking sources beside this panel for current lot and access information.</div>}
