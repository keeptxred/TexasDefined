...
export const preindexVerifiedPaintedChurches: CanonicalPaintedChurch[] = [
  ...
  },
  {
    ...
    shortName: "Immaculate Heart of Mary at San Antonio",
    city: "San Antonio",
    county: "Bexar",
    address: "617 S. Santa Rosa Ave, San Antonio, TX 78204",
    denomination: "Roman Catholic",
    summary: "A 1912 Byzantine Romanesque Claretian church whose walls carry an elaborate stencil program first documented in 1944, followed by a major Fr. Alberto Domingo restoration, 1991 arson damage and a painstaking restoration completed in 1994.",
    significance: "The active parish documents hand-painted wall motifs, stained glass and Hispanic cultural significance, while the Claretian Missionaries Archives reconstruct the original 1944 stencil campaign by a Mexican artist identified as Bartola and the later restoration chronology. Texas Defined includes the church in the broader historic Painted Churches tradition while distinguishing original decoration, restoration and post-fire reconstruction.",
    visitNote: "The official parish says visitors are welcome during regular business hours. Hours can change for meetings, holidays, feast days and parish events, so confirm before traveling specifically to study the interior.",
    sourceUrl: "https://ihmsatx.org/our-history-1",
    secondarySourceUrl: "https://claretianmissionariesarchives.org/a-work-of-heart-a-history-of-the-painted-walls-of-immaculate-heart-of-mary-church/",
    sourceCheckedAt: CHECKED,
    classification: "broader-historic-tradition",
    interiorIntegrity: "restored-original-scheme",
    culturalHeritage: ["Hispanic Catholic", "Claretian Missionary", "Mexican artistic contribution"],
    techniques: ["stenciling", "freehand"],
  },
  {
    ...
    city: "Mason",
    county: "Mason",
    address: "216 Ave B, Mason, TX 76856",
    denomination: "Roman Catholic",
    summary: "An 1876 red-sandstone Catholic church whose vaulted beadboard ceiling was painted in 1916 by Manuel Lopez with clouds, stars, angels and an opening-sky sanctuary scene, then rediscovered and restored as part of a major 2024 preservation campaign.",
    significance: "The parish documents Manuel Lopez's 1916 painted interior in detail, while the 2024 project architect records that the historic painted vault had been covered by acoustical tile, rediscovered in 1989 and restored during the latest renovation. The new campaign extended complementary decorative work while preserving the distinction between Lopez's historic program and modern additions.",
    visitNote: "St. Joseph remains an active Diocese of Austin parish and explicitly welcomes visitors to its newly remodeled worship site. Verify current Masses, events and interior access before making a special art-history visit.",
    sourceUrl: "https://stjosephmason.org/about-us",
    secondarySourceUrl: "https://www.studioiodesign.com/st-joseph-mason",
    sourceCheckedAt: CHECKED,
    classification: "broader-historic-tradition",
    interiorIntegrity: "restored-original-scheme",
    culturalHeritage: ["Central Texas Catholic", "Mexican artistic contribution", "Spanish Baroque-inspired devotional decoration"],
    techniques: ["freehand", "stenciling", "decorative-murals"],
  },
];
