...
const hubNeedles = [
  ...
  '/texas-high-school-football-teams', districtDirectoryPath, classificationsPath, playoffsPath, sixManPath, scoresSchedulesPath, calendarPath, championshipHistoryPath,
];
