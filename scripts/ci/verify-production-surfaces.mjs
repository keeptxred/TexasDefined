...
const surfaces = [
  ...
  ['camping-guide-profile-count', '/best-places-to-go-camping-in-texas', 'Showing 64 of 64 verified profiles.'],
  ['camping-guide-wave9', '/best-places-to-go-camping-in-texas', 'Possum Kingdom State Park'],
  ['camping-guide-san-antonio', '/best-places-to-go-camping-in-texas', 'Government Canyon State Natural Area'],
