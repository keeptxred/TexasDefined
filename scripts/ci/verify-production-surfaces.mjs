...
const surfaces = [
  ...
  ['wildfire-homes-land-byline', '/article/texas-wildfire-home-protection-guide', 'Texas Defined Homes & Land Desk'],
  ['wildfire-homes-land-schema', '/article/texas-wildfire-home-protection-guide', 'https://texasdefined.com/authors/a-homes-land#desk'],
  ['homes-land-desk-profile', '/authors/a-homes-land', 'not a substitute for licensed legal, insurance, engineering or trade advice'],
