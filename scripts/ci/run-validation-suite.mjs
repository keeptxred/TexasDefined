...
const checks = [
  ...
  ['camping-public-authority-wave9', 'CONTENT/AUTHORITY', 'Validate camping public authority Wave 9 / final integrity', 'node', ['scripts/data/validate-camping-public-authority-wave9.mjs']],
