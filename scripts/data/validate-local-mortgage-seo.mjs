...
for (const marker of ["defaultCountySlug = ''", 'useUrlStateDefaults', 'county: defaultCountySlug', 'OfficialTaxRateAssist', 'CountySelector']) if (!mortgageCalculator.includes(marker)) failures.push(`Official mortgage calculator local-context support missing ${marker}`);
