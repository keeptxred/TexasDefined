...
console.log("PASS: one source-qualified Texas event contract powers statewide and venue-scoped calendars/carousels with rights-safe imagery, venue-guide hero deduplication by URL or source identity, freshness disclosure, accessible controls, distinct venue event/calendar actions, a server-bounded venue payload, the existing Stay Nearby slot, a lazy-mount refresh guard, and route-split styling that protects the main client bundle.");
