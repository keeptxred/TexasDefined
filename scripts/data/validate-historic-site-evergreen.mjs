...
console.log(`Historic-site evergreen validation passed: ${guides.length + militaryGuides.length} authority guides and ${weekendGuides.length} historic weekend planning guides retain substantive depth, authoritative sourcing, verified destination links, reciprocal discovery, lazy loading, repository listing and canonical article-sitemap publication.`);
