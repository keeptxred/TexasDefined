...
if (citationIndex) {
  ...
  for (const url of [
    ...
    'https://texasdefined.com/texas-homecoming',
...
for (const feature of [
  ...
  if (!texasExplainedCollectionSource.includes(feature)) errors.push(`Texas Explained collection contract missing: ${feature}`);
}
for (const feature of [
