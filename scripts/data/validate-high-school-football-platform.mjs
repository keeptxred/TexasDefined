...
if (!errors.length) {
  ...
  for (const marker of [
    ...
    'Every current UIL football program is listed here on the same basis.',
    'All 1,268',
    '6A → 1A · enrollment classification',
    'A 6A school appears above a 5A school because it is in the larger-enrollment classification',
    'Read school football profile →',
    'not because one football program is rated better',
    'UIL enrollment band:',
