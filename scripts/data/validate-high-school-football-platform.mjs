...
if (!errors.length) {
  ...
  if (legacyProgramMetadata.includes('primaryRank') || legacyProgramMetadata.includes('sourceRanks')) errors.push('Legacy football seed metadata must use source-position terminology, not ranking terminology.');
  requireText(legacyProgramMetadata, 'sourcePositions', 'Legacy football seed metadata');
  requireText(legacyProgramMetadata, 'firstSourcePosition', 'Legacy football seed metadata');
