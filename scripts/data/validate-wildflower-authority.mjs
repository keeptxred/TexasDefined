...
for (const feature of ['WildflowerSpeciesGrid','11 Texas wildflowers to know','Scientific','Bloom','Texas range','Open species guide']) {
...
const remoteImageCount = (fixture.match(/commonsImage\(/g) ?? []).length - 1;
if (remoteImageCount < 11) errors.push(`Expected at least 11 licensed species image records, found ${remoteImageCount}.`);
