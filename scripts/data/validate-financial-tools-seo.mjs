...
const affordabilityRoute = fs.readFileSync('src/routes/texas-home-affordability-calculator.$location.tsx', 'utf8');
const affordabilityLazyRoute = fs.readFileSync('src/routes/texas-home-affordability-calculator.$location.lazy.tsx', 'utf8');
