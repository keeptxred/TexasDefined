...
for (const domain of [
  ...
  "humanitiestexas.org", "texashistory.unt.edu", "tpwd.texas.gov", "thc.texas.gov",
...
for (const contextualToken of [
  ...
  "Interwoven: A Pioneer Chronicle", "orphaned southern-plains bison",
...
for (const token of [
  ...
  "TEXAS_ICON_RESEARCH_HISTORY_BATCH_5", "TEXAS_ICON_RESEARCH_HISTORY_BATCH_6", "TEXAS_ICON_RESEARCH_PROFILES",
