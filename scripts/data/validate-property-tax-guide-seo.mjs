...
for (const forbidden of ['schoolRate: 1,', 'otherRate: 1.2,', 'schoolCeiling: 2500']) {
  if (over65Calculator.includes(forbidden)) errors.push(`Over-65 property-tax calculator must not restore invented statewide/local defaults: ${forbidden}.`);
}
