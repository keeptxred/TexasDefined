...
const sitemapDeps = read('src/data/sitemap-dependencies.server.ts');
const failures = [];
...
if (!sitemapDeps.includes('export { hasCurrentOrFutureConfirmedEventOccurrence } from "@/data/event-occurrence-lifecycle";')) {
