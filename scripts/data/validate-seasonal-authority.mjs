...
if (!process.exitCode) console.log("Seasonal authority guardrail passed: 21 bluebonnet/Christmas/fall pages, reciprocal links, safety/currentness caveats and lazy loading verified.");
