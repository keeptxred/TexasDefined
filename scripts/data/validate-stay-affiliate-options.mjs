...
for (const [needle, label] of [
  ...
  ['function placeBookingChoice(expediaSurface, choice)', 'curated-versus-generic booking choice ordering'],
  ['expediaSurface.dataset.surfaceType === "curated"', 'curated surface ordering guard'],
  ['expediaSurface.appendChild(choice)', 'broad stay choices follow curated exact-property cards'],
  ['choice.dataset.presentationOrder = "after-curated"', 'curated ordering marker'],
  ['expediaSurface.prepend(choice)', 'generic-only surface keeps broad choices primary'],
  ['choice.dataset.presentationOrder = "generic-primary"', 'generic ordering marker'],
