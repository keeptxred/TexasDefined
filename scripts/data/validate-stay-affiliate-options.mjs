...
for (const [needle, label] of [
  ...
  ['choice.parentElement === surface && choice === surface.firstElementChild', 'broad-search placement idempotence guard'],
  ['choice.parentElement === surface && choice.nextElementSibling === scopedStyle', 'exact-property placement idempotence guard'],
  ['choice.parentElement === surface && choice === surface.lastElementChild', 'exact-property append idempotence guard'],
