...
const checks = [
  ...
  [hurstWhirlyballProductionWorkflow, 'statuses: write', 'Hurst/WhirlyBall production smoke must be allowed to publish an auditable commit status'],
  ...
  [hurstWhirlyballProductionVerifier, 'function requireNearbyLink(html, label, href, message)', 'Hurst/WhirlyBall production verifier must bind local labels to nearby canonical links'],
  [hurstWhirlyballProductionVerifier, 'Use the Hurst city guide for verified local systems, schools, parks, rail access and Mid-Cities context', 'Hurst/WhirlyBall production verifier must reject the stale Tarrant-only neighborhood copy'],
  [hurstWhirlyballProductionVerifier, "'Hurst and HEB Mid-Cities dining'", 'Hurst/WhirlyBall production verifier must inspect the Hurst dining link block'],
  [hurstWhirlyballProductionVerifier, "'Hurst and the HEB Mid-Cities'", 'Hurst/WhirlyBall production verifier must inspect the Hurst neighborhood link block'],
