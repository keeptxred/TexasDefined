...
const propertyTaxEngineRoutes = ['src/routes/texas-property-tax-estimator.tsx','src/routes/texas-agricultural-valuation-calculator.tsx','src/routes/texas-disabled-veteran-property-tax-calculator.tsx','src/routes/texas-over-65-property-tax-calculator.tsx','src/routes/texas-property-tax-county-comparison-calculator.tsx','src/routes/texas-property-tax-escrow-calculator.tsx','src/routes/texas-property-tax-protest-savings-calculator.tsx','src/components/property/LocalPropertyTaxCalculatorPage.tsx','src/routes/texas-school-district-property-tax-comparison.tsx','src/routes/texas-property-tax-bill-breakdown.tsx'];
